...
--
-- Host: localhost
-- Generation Time: Sep 06, 2025 at 03:56 AM
...
-- Database: `bbc`
--
CREATE DATABASE `bbc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bbc`;
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `EmplName` varchar(100) NOT NULL DEFAULT '',
...
INSERT INTO `employee` (`EmpID`, `EmplName`, `DOB`, `Salary`) VALUES
(2, 'czar', '2025-03-06', 20000000);
--
-- Database: `bbcb`
--
CREATE DATABASE `bbcb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bbcb`;
...
INSERT INTO `employee` (`EmpID`, `EmpName`, `DOB`, `Salary`) VALUES
(2, 'mj', '2000-02-01', 10000);
--
-- Database: `brightminds`
--
CREATE DATABASE `brightminds` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `brightminds`;
...
(1, 'NAMAZZI', '2300714493@mubs.ac.ugHELLO', 'HI');
...
INSERT INTO `minds` (`UserID`, `FirstName`, `LastName`, `Email`, `Password`, `ComfirmPassword`) VALUES
(1, 'grace', 'namazzi', 'Namazzi2003@gmail.com', '123', ''),
(2, 'Connie', 'Nshabohurira', 'connie@gmail.com', '345', ''),
(3, 'Connie', 'Nshabohurira', 'connie@gmail.com', '345', ''),
(4, 'Connie', 'Nshabohurira', 'connie@gmail.com', '345', ''),
(5, 'Connie', 'Nshabohurira', 'connie@gmail.com', '345', '345'),
(6, '', '', '', '', ''),
(7, '', 'Nshabohurira', 'connie@gmail.com', '45', '45'),
(8, '', 'Nshabohurira', 'connie@gmail.com', '45', '45'),
(9, '', 'Nshabohurira', 'connie@gmail.com', '45', '45'),
(10, '', 'Nshabohurira', 'connie@gmail.com', '45', '45'),
(11, '', 'Nshabohurira', 'connie@gmail.com', '45', '45'),
(12, '', 'Grace', '2300714493@mubs.ac.ug', '300', '300'),
(13, '', 'Grace', '2300714493@mubs.ac.ug', '300', '300'),
(14, 'Moreen', 'Grace', '2300714493@mubs.ac.ug', '300', '300'),
(15, 'Moreen', 'Grace', '2300714493@mubs.ac.ug', '4321', '4321'),
(16, '', '', '', '', ''),
(17, 'Moreen', 'Grace', '2300714493@mubs.ac.ug', '4321', '4321'),
(18, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(19, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(20, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(21, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(22, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(23, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(24, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(25, 'grace', 'grace', 'grace@grace.com', '345', '345'),
(26, 'Rona', 'Rnnie', 'rona@ronnie.com', '12', '12'),
(27, 'man', 'united', 'man@united.com', '100', '100'),
(28, 'jane', 'jane', 'jane@jane.com', '200', '200'),
(29, 'jane', 'jane', 'jane@jane.com', '200', '200'),
(30, 'jane', 'jane', 'jane@jane.com', '200', '200'),
(31, 'jane', 'grace', 'jane@jane.com', '200', '200'),
(32, 'jane', 'grace', 'jane@jane.com', '200', '200'),
(33, 'grace', 'namazzi', '2300714493@mubs.ac.ug', '123', '123'),
(34, 'grace', 'namazzi', '2300714493@mubs.ac.ug', '123', '123'),
(35, 'grace', 'namazzi', '2300714493@mubs.ac.ug', '123', '123'),
(36, '', '', '', '', ''),
(37, 'Julius', 'Mukubya', 'mukubyajulius@gmail.com', '123', '123');
--
-- Database: `coffewebsitedb`
--
CREATE DATABASE `coffewebsitedb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `coffewebsitedb`;
...
INSERT INTO `messages` (`messageid`, `username`, `email`, `subject`, `message`) VALUES
(1, 'Julius', '', 'Complaint', 'too much work');
...
(1, 'Julius', 'mukubyajulius@gmail.com', '123'),
(2, 'abc', 'abc@gmail.com', '123'),
(3, 'John', 'john@gmail.com', '123'),
(5, 'james', 'james@gmail.com', '123'),
(6, 'Elizabeth', 'elizabeth@gmail.com', '123'),
(7, 'betty', 'betty@gmail.com', '123'),
(8, 'nadia', 'nalukwagosandra@gmail.com', '123'),
(11, 'dfgt', 'mukubyajulius@gmail.com', '123'),
(12, 'Smith', 'leemeeya851@gmail.com', '123'),
(13, 'Smith', 'leemeeya851@gmail.com', '123');
...
--
CREATE DATABASE `employeedatabase` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
INSERT INTO `employee` (`emp_id`, `name`, `job_title`) VALUES
(1, 'Julius', 'Developer');
--
-- Database: `farmer_management`
--
CREATE DATABASE `farmer_management` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `farmer_management`;

-- --------------------------------------------------------

--
-- Table structure for table `advisory_logs`
--
...
CREATE TABLE IF NOT EXISTS `advisory_logs` (
  ...
  `advice_type` enum('crop_advice','pest_management') NOT NULL,
...
--
-- Dumping data for table `advisory_logs`
--
...
CREATE TABLE IF NOT EXISTS `crops` (
  ...
  `soil_moisture_level` decimal(5,2) DEFAULT '0.00',
...
INSERT INTO `crops` (`id`, `farmer_id`, `crop_name`, `soil_type`, `weather_conditions`, `soil_moisture_level`, `planting_date`, `created_at`) VALUES
(1, 1, 'Maize', 'Loamy', 'Moderate rainfall', '65.50', '2024-03-15', '2025-08-03 19:37:10'),
(2, 1, 'Tomatoes', 'Clay', 'High humidity', '72.30', '2024-04-01', '2025-08-03 19:37:10'),
(3, 2, 'Wheat', 'Sandy', 'Dry conditions', '45.20', '2024-02-20', '2025-08-03 19:37:10');
...
(1, 'John Doe', 'john@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-08-03 19:37:10'),
(2, 'Jane Smith', 'jane@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2025-08-03 19:37:10');
--
-- Database: `freshmartdb`
--
CREATE DATABASE `freshmartdb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `freshmartdb`;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `productGroup` varchar(45) NOT NULL DEFAULT '',
...
INSERT INTO `products` (`productNo`, `productName`, `price`, `productGroup`, `expiryDate`) VALUES
(1, 'Coke', 2000, 'Drinks', '2025-05-22'),
(2, 'Bread', 5000, 'Foods', '2025-05-14');
...
(1, 'Julius', 'MJ', '123', 'admin'),
(2, 'John', 'john123', '123', 'cashier');
--
-- Database: `hostel_system`
--
CREATE DATABASE `hostel_system` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hostel_system`;
...
INSERT INTO `availability_status` (`id`, `hostel_id`, `is_available`, `reason`, `available_from`, `available_until`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL, NULL, '2025-06-29 08:50:27', NULL),
(2, 2, 1, NULL, NULL, NULL, '2025-06-29 08:50:27', NULL);
...
INSERT INTO `booking_info` (`id`, `hostel_id`, `min_booking_duration`, `min_booking_unit`, `advance_payment`, `advance_payment_unit`, `refund_policy`, `payment_methods`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 'Months', '5000.00', 'KES', 'Refundable within 7 days of check-in.', 'Cash, Bank Transfer', '2025-06-29 08:50:27', NULL),
(2, 2, 2, 'Months', '4000.00', 'KES', 'Non-refundable.', 'Cash, Mobile Money', '2025-06-29 08:50:27', NULL);
...
INSERT INTO `facilities` (`id`, `name`, `category`, `icon`, `created_at`) VALUES
(1, 'Wi-Fi', 'Basic', 'wifi', '2025-06-29 08:49:56'),
(2, 'Electricity Backup', 'Basic', 'power', '2025-06-29 08:49:56'),
(3, 'Laundry Services', 'Basic', 'laundry', '2025-06-29 08:49:56'),
(4, 'Meals', 'Basic', 'food', '2025-06-29 08:49:56'),
(5, 'Security Guard', 'Security', 'security', '2025-06-29 08:49:56'),
(6, 'CCTV Cameras', 'Security', 'camera', '2025-06-29 08:49:56'),
(7, 'Air Conditioning', 'Premium', 'ac', '2025-06-29 08:49:56'),
(8, 'Hot Water', 'Basic', 'hot-water', '2025-06-29 08:49:56'),
(9, 'Kitchen Access', 'Basic', 'kitchen', '2025-06-29 08:49:56'),
(10, 'Study Room', 'Basic', 'study', '2025-06-29 08:49:56'),
(11, 'Common Lounge', 'Basic', 'lounge', '2025-06-29 08:49:56'),
(12, 'Parking Space', 'Basic', 'parking', '2025-06-29 08:49:56'),
(13, 'Gym Access', 'Premium', 'gym', '2025-06-29 08:49:56'),
(14, 'Swimming Pool', 'Premium', 'pool', '2025-06-29 08:49:56'),
(15, 'Garden/Outdoor Space', 'Premium', 'garden', '2025-06-29 08:49:56'),
(16, 'Medical Support', 'Health', 'medical', '2025-06-29 08:49:56'),
(17, '24/7 Reception', 'Basic', 'reception', '2025-06-29 08:49:56'),
(18, 'Cleaning Services', 'Basic', 'cleaning', '2025-06-29 08:49:56'),
(19, 'Internet Cafe', 'Entertainment', 'cafe', '2025-06-29 08:49:56'),
(20, 'Game Room', 'Entertainment', 'games', '2025-06-29 08:49:56');

-- --------------------------------------------------------

--
-- Table structure for table `hostel_descriptions`
--

CREATE TABLE IF NOT EXISTS `hostel_descriptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hostel_id` int(11) NOT NULL,
  `overview` text,
  `hostel_rules` text,
...
--
-- Dumping data for table `hostel_descriptions`
--

INSERT INTO `hostel_descriptions` (`id`, `hostel_id`, `overview`, `hostel_rules`, `check_in_time`, `check_out_time`, `security_features`, `created_at`, `updated_at`) VALUES
(1, 1, 'Modern hostel with all amenities.', 'No loud music after 10pm.', '14:00:00', '10:00:00', '24/7 security, CCTV', '2025-06-29 08:50:27', NULL),
(2, 2, 'Comfortable and secure for girls.', 'Visitors allowed till 8pm.', '13:00:00', '11:00:00', 'Security guard, CCTV', '2025-06-29 08:50:27', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `hostel_drafts`
--

CREATE TABLE IF NOT EXISTS `hostel_drafts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hostel_drafts`
--
...
INSERT INTO `hostel_facilities` (`id`, `hostel_id`, `facility_id`, `is_available`, `created_at`) VALUES
(1, 1, 1, 1, '2025-06-29 08:50:27'),
(2, 1, 2, 1, '2025-06-29 08:50:27'),
(3, 1, 3, 1, '2025-06-29 08:50:27'),
(4, 1, 4, 1, '2025-06-29 08:50:27'),
(5, 1, 5, 1, '2025-06-29 08:50:27'),
(6, 1, 6, 1, '2025-06-29 08:50:27'),
(7, 2, 1, 1, '2025-06-29 08:50:27'),
(8, 2, 2, 1, '2025-06-29 08:50:27'),
(9, 2, 3, 1, '2025-06-29 08:50:27'),
(10, 2, 4, 1, '2025-06-29 08:50:27'),
(11, 2, 5, 1, '2025-06-29 08:50:27'),
(12, 2, 6, 1, '2025-06-29 08:50:27');

-- --------------------------------------------------------

--
-- Table structure for table `hostel_locations`
--

CREATE TABLE IF NOT EXISTS `hostel_locations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hostel_id` int(11) NOT NULL,
  `full_address` text NOT NULL,
  `city` varchar(100) NOT NULL,
  `landmarks` text,
  `distance_from_campus` varchar(50) DEFAULT NULL,
  `directions` text,
...
--
-- Dumping data for table `hostel_locations`
--

INSERT INTO `hostel_locations` (`id`, `hostel_id`, `full_address`, `city`, `landmarks`, `distance_from_campus`, `directions`, `latitude`, `longitude`, `created_at`, `updated_at`) VALUES
(1, 1, '123 University Ave', 'Campus City', 'Near Main Gate', '500m', 'Straight from gate', '0.00000000', '0.00000000', '2025-06-29 08:50:27', NULL),
(2, 2, '456 College Road', 'Campus City', 'Opposite Library', '700m', 'Left at library', '0.00000000', '0.00000000', '2025-06-29 08:50:27', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `hostel_payment_methods`
--
...
--
-- Dumping data for table `hostel_payment_methods`
--
...
CREATE TABLE IF NOT EXISTS `hostel_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hostel_id` int(11) NOT NULL,
  `photo_type` enum('Front View','Room','Bathroom','Common Area','Facility','Exterior','Interior') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hostel_rooms` (
  ...
  `availability_count` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `hostel_rooms` (`id`, `hostel_id`, `room_type_id`, `price`, `availability_count`, `furnishing`, `room_size`, `max_occupancy`, `additional_features`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '12000.00', 10, 'Bed, Table, Chair', '12.00', 1, 'Balcony', '2025-06-29 08:50:27', NULL),
(2, 1, 2, '9000.00', 8, 'Bed, Table, Chair', '18.00', 2, 'Shared Bathroom', '2025-06-29 08:50:27', NULL),
(3, 2, 1, '11000.00', 12, 'Bed, Table, Chair', '12.00', 1, 'Garden View', '2025-06-29 08:50:27', NULL),
(4, 2, 2, '8500.00', 10, 'Bed, Table, Chair', '18.00', 2, 'Shared Bathroom', '2025-06-29 08:50:27', NULL);
...
INSERT INTO `hostels` (`id`, `name`, `type`, `owner_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 'University Heights Hostel', 'Mixed', 1, 'Active', '2025-06-29 08:50:27', NULL),
(2, 'Student Comfort Lodge', 'Girls', 2, 'Active', '2025-06-29 08:50:27', NULL);
...
INSERT INTO `inquiries` (`id`, `hostel_id`, `inquirer_name`, `contact_number`, `email`, `message`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Carol', '0700000000', 'carol@email.com', 'Is there parking?', 'Responded', '2025-06-29 08:50:27', NULL),
(2, 2, 'Dave', '0711111111', 'dave@email.com', 'Are meals included?', 'Responded', '2025-06-29 08:50:27', NULL);
...
INSERT INTO `owners` (`id`, `name`, `contact_number`, `email`, `created_at`, `updated_at`) VALUES
(1, 'John Doe', '0712345678', 'john.doe@email.com', '2025-06-29 08:50:27', NULL),
(2, 'Jane Smith', '0723456789', 'jane.smith@email.com', '2025-06-29 08:50:27', NULL);
...
(1, 'Cash', 'Cash payment on arrival', 1, '2025-06-29 08:49:56'),
(2, 'Bank Transfer', 'Direct bank transfer', 1, '2025-06-29 08:49:56'),
(3, 'Credit Card', 'Credit card payment', 1, '2025-06-29 08:49:56'),
(4, 'Debit Card', 'Debit card payment', 1, '2025-06-29 08:49:56'),
(5, 'Mobile Money', 'Mobile money transfer', 1, '2025-06-29 08:49:56'),
(6, 'Online Payment', 'Online payment gateway', 1, '2025-06-29 08:49:56');
...
INSERT INTO `reviews` (`id`, `hostel_id`, `reviewer_name`, `rating`, `comment`, `is_approved`, `created_at`) VALUES
(1, 1, 'Alice', 5, 'Great hostel!', 1, '2025-06-29 08:50:27'),
(2, 2, 'Bob', 4, 'Very comfortable.', 1, '2025-06-29 08:50:27');
...
(1, 'Single Room', 'Private room for one person', '2025-06-29 08:49:56'),
(2, 'Double Room', 'Room shared by two people', '2025-06-29 08:49:56'),
(3, 'Triple Room', 'Room shared by three people', '2025-06-29 08:49:56'),
(4, 'Quad Room', 'Room shared by four people', '2025-06-29 08:49:56'),
(5, 'Deluxe Single', 'Premium single room with extra amenities', '2025-06-29 08:49:56'),
(6, 'Deluxe Double', 'Premium double room with extra amenities', '2025-06-29 08:49:56');
...
(1, 'admin', 'admin@hostel.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 1, NULL, '2025-06-29 08:49:56', NULL);
--
...
(NULL, 'bbc', 'employee', 'EmpID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'bbc', 'employee', 'EmplName', 2, '', 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'bbc', 'employee', 'DOB', 3, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'bbc', 'employee', 'Salary', 4, '0', 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'bbcb', 'employee', 'EmpID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'bbcb', 'employee', 'EmpName', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'bbcb', 'employee', 'DOB', 3, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'bbcb', 'employee', 'Salary', 4, '0', 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double unsigned', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'contact', 'UserID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'contact', 'Name', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'contact', 'Email', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'contact', 'message', 4, NULL, 'NO', 'varchar', 10000, 10000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10000)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'UserID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'FirstName', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'LastName', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'Email', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'Password', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'brightminds', 'minds', 'ComfirmPassword', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'messages', 'messageid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'messages', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'messages', 'email', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'messages', 'subject', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'messages', 'message', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'users', 'userid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'users', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'users', 'email', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'coffewebsitedb', 'users', 'password', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'demo', 'user', 'userID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'demo', 'user', 'userName', 2, '', 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'demo', 'user', 'password', 3, '', 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'employeedatabase', 'employee', 'emp_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'employeedatabase', 'employee', 'name', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'employeedatabase', 'employee', 'job_title', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'farmer_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'crop_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'advice_type', 4, NULL, 'NO', 'enum', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''crop_advice'',''pest_management'')', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'advice_content', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'advisory_logs', 'created_at', 6, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'farmer_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'crop_name', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'soil_type', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'weather_conditions', 5, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'soil_moisture_level', 6, '0.00', 'YES', 'decimal', NULL, NULL, 5, 2, NULL, NULL, 'decimal(5,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'planting_date', 7, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'crops', 'created_at', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'farmers', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'farmers', 'name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'farmers', 'email', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'farmers', 'password', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'farmer_management', 'farmers', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'products', 'productNo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'products', 'productName', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'products', 'price', 3, '0', 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'products', 'productGroup', 4, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'products', 'expiryDate', 5, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'users', 'name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'users', 'username', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'users', 'password', 4, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'freshmartdb', 'users', 'role', 5, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'is_available', 3, '1', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'reason', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'available_from', 5, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'available_until', 6, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'created_at', 7, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'availability_status', 'updated_at', 8, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'min_booking_duration', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'min_booking_unit', 4, NULL, 'NO', 'enum', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''Hours'',''Days'',''Weeks'',''Months'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'advance_payment', 5, NULL, 'NO', 'decimal', NULL, NULL, 10, 2, NULL, NULL, 'decimal(10,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'advance_payment_unit', 6, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'refund_policy', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'payment_methods', 8, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'created_at', 9, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'booking_info', 'updated_at', 10, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'facilities', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'facilities', 'name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'facilities', 'category', 3, 'Basic', 'YES', 'enum', 13, 13, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''Basic'',''Premium'',''Security'',''Entertainment'',''Health'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'facilities', 'icon', 4, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'facilities', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'overview', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'hostel_rules', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'check_in_time', 5, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'check_out_time', 6, NULL, 'YES', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'security_features', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'created_at', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'updated_at', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'owner_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'draft_data', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'current_step', 4, '1', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'last_saved', 5, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'created_at', 6, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'updated_at', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'facility_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'is_available', 4, '1', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'full_address', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'city', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'landmarks', 5, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'distance_from_campus', 6, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'directions', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'latitude', 8, NULL, 'YES', 'decimal', NULL, NULL, 10, 8, NULL, NULL, 'decimal(10,8)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'longitude', 9, NULL, 'YES', 'decimal', NULL, NULL, 11, 8, NULL, NULL, 'decimal(11,8)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'created_at', 10, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_locations', 'updated_at', 11, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'payment_method_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'is_available', 4, '1', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'photo_type', 3, NULL, 'NO', 'enum', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''Front View'',''Room'',''Bathroom'',''Common Area'',''Facility'',''Exterior'',''Interior'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'file_name', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'file_path', 5, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'file_size', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'mime_type', 7, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'is_primary', 8, '0', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_photos', 'uploaded_at', 9, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'room_type_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 10, 2, NULL, NULL, 'decimal(10,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'availability_count', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'furnishing', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'room_size', 7, NULL, 'YES', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'max_occupancy', 8, '1', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'additional_features', 9, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'created_at', 10, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'updated_at', 11, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'type', 3, NULL, 'NO', 'enum', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''Mixed'',''Boys'',''Girls'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'owner_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'status', 5, 'Pending', 'YES', 'enum', 9, 9, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''Active'',''Inactive'',''Pending'',''Suspended'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'created_at', 6, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'hostels', 'updated_at', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'inquirer_name', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'contact_number', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'email', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'message', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'status', 7, 'New', 'YES', 'enum', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''New'',''In Progress'',''Responded'',''Closed'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'created_at', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'inquiries', 'updated_at', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'contact_number', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'email', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'owners', 'updated_at', 6, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'payment_methods', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'payment_methods', 'name', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'payment_methods', 'description', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'payment_methods', 'is_active', 4, '1', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'payment_methods', 'created_at', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'hostel_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'reviewer_name', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'rating', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'comment', 5, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'is_approved', 6, '0', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'reviews', 'created_at', 7, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'room_types', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'room_types', 'name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'room_types', 'description', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'room_types', 'created_at', 4, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'email', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'password_hash', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'role', 5, NULL, 'NO', 'enum', 14, 14, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''admin'',''hostel_manager'',''owner'')', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'is_active', 6, '1', 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'last_login', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'created_at', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'hostel_system', 'users', 'updated_at', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'mubs_db', 'user', 'userid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'mubs_db', 'user', 'username', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'mubs_db', 'user', 'password', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'mubsdb', 'students', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'mubsdb', 'students', 'student_name', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'mubsdb', 'students', 'student_reg_no', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'mubsdb', 'students', 'student_age', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'mubsdb', 'students', 'student_email', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
...
(NULL, 'regform', 'reglist', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'regform', 'reglist', 'name', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'regform', 'reglist', 'email', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'regform', 'reglist', 'message', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'registerform', 'register', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'registerform', 'register', 'name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'registerform', 'register', 'password', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'registration', 'details', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'registration', 'details', 'name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'registration', 'details', 'password', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'registration', 'logging', 'name', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'registration', 'logging', 'password', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'completed_courses', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'completed_courses', 'user_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'completed_courses', 'course_id', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'completed_courses', 'completion_date', 4, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'course_outline', 'outline_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'course_outline', 'course_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'course_outline', 'module_number', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'course_outline', 'module_title', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'course_outline', 'module_link', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'course_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'course_title', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'course_description', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'course_image_url', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'language', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'rating', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'created_at', 7, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'courses', 'updated_at', 8, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'current_course_page', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'current_course_page', 'course_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'current_course_page', 'outline_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'current_course_page', 'module_number', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'enrollments', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'enrollments', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'enrollments', 'course_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'enrollments', 'enrolled_at', 4, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'messages', 'messageid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'messages', 'name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'messages', 'email', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'messages', 'message', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'notes', 'note_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'notes', 'course_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'notes', 'outline_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'notes', 'section_title', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'notes', 'section_content', 5, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'name', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'email', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'role', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'password', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'skillquest', 'users', 'created_at', 6, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'customer', 'customer_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'customer', 'customer_name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'customer', 'phone', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'customer', 'address', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'employee', 'employee_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'employee', 'project_ID', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'employee', 'employee_name', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'employee', 'phone', 4, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'employee', 'address', 5, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory', 'inventory_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory', 'item_name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory', 'quantity', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_orders', 'order_ID', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_orders', 'inventory_ID', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_orders', 'quantity', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_orders', 'cost', 4, '0', 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_orders', 'total', 5, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_supplier', 'inventory_ID', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_supplier', 'supplier_ID', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'inventory_supplier', 'unit_cost', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'orders', 'order_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'orders', 'supplier_ID', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'orders', 'order_date', 3, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'orders', 'order_status', 4, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'project_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'customer_ID', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'project_name', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'start_date', 4, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'end_date', 5, '0000-00-00', 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'budget', 6, '0', 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project', 'status', 7, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project_inventory', 'inventory_ID', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project_inventory', 'project_ID', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project_inventory', 'quantity', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'project_inventory', 'cost', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'supplier', 'supplier_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'supplier', 'supplier_name', 2, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'supplier', 'email', 3, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'supplier', 'address', 4, '', 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'user', 'user_ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'skyline', 'user', 'username', 2, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'user', 'password', 3, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'skyline', 'user', 'role', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
(NULL, 'studentdatabase', 'student', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'studentdatabase', 'student', 'name', 2, '', 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'studentdatabase', 'student', 'program', 3, '', 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'userdatabase', 'user', 'userid', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'userdatabase', 'user', 'username', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'userdatabase', 'user', 'password', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', '');
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '16'),
('CREATED_TMP_DISK_TABLES', '736'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '2287'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '156'),
('HANDLER_READ_KEY', '151'),
('HANDLER_READ_NEXT', '2925'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '17955'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '15255'),
...
('INNODB_ROWS_READ', '263'),
('INNODB_ROWS_UPDATED', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '14347'),
('KEY_BLOCKS_USED', '15'),
('KEY_READ_REQUESTS', '171'),
('KEY_READS', '45'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\DESKTOP-4RLKU59.pid'),
('QUERY_CACHE_SIZE', '0'),
('PROFILING', 'OFF'),
('HAVE_INNODB', 'YES'),
('THREAD_STACK', '196608'),
...
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\DESKTOP-4RLKU59.log'),
('SSL_CERT', ''),
('HOSTNAME', 'DESKTOP-4RLKU59'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.36\\data\\DESKTOP-4RLKU59-slow.log'),
...
(NULL, 'bbc', 'PRIMARY', NULL, 'bbc', 'employee', 'EmpID', 1, NULL, NULL, NULL, NULL),
(NULL, 'bbcb', 'PRIMARY', NULL, 'bbcb', 'employee', 'EmpID', 1, NULL, NULL, NULL, NULL),
(NULL, 'brightminds', 'PRIMARY', NULL, 'brightminds', 'contact', 'UserID', 1, NULL, NULL, NULL, NULL),
(NULL, 'brightminds', 'PRIMARY', NULL, 'brightminds', 'minds', 'UserID', 1, NULL, NULL, NULL, NULL),
(NULL, 'coffewebsitedb', 'PRIMARY', NULL, 'coffewebsitedb', 'messages', 'messageid', 1, NULL, NULL, NULL, NULL),
(NULL, 'coffewebsitedb', 'PRIMARY', NULL, 'coffewebsitedb', 'users', 'userid', 1, NULL, NULL, NULL, NULL),
(NULL, 'demo', 'PRIMARY', NULL, 'demo', 'user', 'userID', 1, NULL, NULL, NULL, NULL),
(NULL, 'employeedatabase', 'PRIMARY', NULL, 'employeedatabase', 'employee', 'emp_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'farmer_management', 'PRIMARY', NULL, 'farmer_management', 'advisory_logs', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'farmer_management', 'PRIMARY', NULL, 'farmer_management', 'crops', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'farmer_management', 'PRIMARY', NULL, 'farmer_management', 'farmers', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'farmer_management', 'email', NULL, 'farmer_management', 'farmers', 'email', 1, NULL, NULL, NULL, NULL),
(NULL, 'freshmartdb', 'PRIMARY', NULL, 'freshmartdb', 'products', 'productNo', 1, NULL, NULL, NULL, NULL),
(NULL, 'freshmartdb', 'PRIMARY', NULL, 'freshmartdb', 'users', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'availability_status', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'booking_info', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'facilities', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'name', NULL, 'hostel_system', 'facilities', 'name', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_descriptions', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_drafts', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_facilities', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_locations', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_payment_methods', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_photos', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostel_rooms', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'hostels', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'inquiries', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'owners', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'email', NULL, 'hostel_system', 'owners', 'email', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'payment_methods', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'name', NULL, 'hostel_system', 'payment_methods', 'name', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'reviews', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'room_types', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'name', NULL, 'hostel_system', 'room_types', 'name', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'PRIMARY', NULL, 'hostel_system', 'users', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'username', NULL, 'hostel_system', 'users', 'username', 1, NULL, NULL, NULL, NULL),
(NULL, 'hostel_system', 'email', NULL, 'hostel_system', 'users', 'email', 1, NULL, NULL, NULL, NULL),
(NULL, 'mubs_db', 'PRIMARY', NULL, 'mubs_db', 'user', 'userid', 1, NULL, NULL, NULL, NULL),
(NULL, 'mubsdb', 'PRIMARY', NULL, 'mubsdb', 'students', 'id', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'regform', 'PRIMARY', NULL, 'regform', 'reglist', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'registerform', 'PRIMARY', NULL, 'registerform', 'register', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'registration', 'PRIMARY', NULL, 'registration', 'details', 'ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'registration', 'PRIMARY', NULL, 'registration', 'logging', 'name', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'completed_courses', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'course_outline', 'outline_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'courses', 'course_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'current_course_page', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'enrollments', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'user_id', NULL, 'skillquest', 'enrollments', 'user_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'user_id', NULL, 'skillquest', 'enrollments', 'course_id', 2, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'messages', 'messageid', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'notes', 'note_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'PRIMARY', NULL, 'skillquest', 'users', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'skillquest', 'email', NULL, 'skillquest', 'users', 'email', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'customer', 'customer_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'employee', 'employee_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'project_ID', NULL, 'skyline', 'employee', 'project_ID', 1, 1, 'skyline', 'project', 'project_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'inventory', 'inventory_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'inventory_orders', 'order_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'inventory_orders', 'inventory_ID', 2, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'FK_inventory_orders_1', NULL, 'skyline', 'inventory_orders', 'inventory_ID', 1, 1, 'skyline', 'inventory', 'inventory_ID'),
(NULL, 'skyline', 'FK_inventory_orders_2', NULL, 'skyline', 'inventory_orders', 'order_ID', 1, 1, 'skyline', 'orders', 'order_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'inventory_supplier', 'inventory_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'inventory_supplier', 'supplier_ID', 2, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'fk_inventory_ID', NULL, 'skyline', 'inventory_supplier', 'inventory_ID', 1, 1, 'skyline', 'inventory', 'inventory_ID'),
(NULL, 'skyline', 'fk_supplier_ID', NULL, 'skyline', 'inventory_supplier', 'supplier_ID', 1, 1, 'skyline', 'supplier', 'supplier_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'orders', 'order_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'fk_orders', NULL, 'skyline', 'orders', 'supplier_ID', 1, 1, 'skyline', 'supplier', 'supplier_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'project', 'project_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'customer_ID', NULL, 'skyline', 'project', 'customer_ID', 1, 1, 'skyline', 'customer', 'customer_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'project_inventory', 'inventory_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'project_inventory', 'project_ID', 2, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'fk_inventory_ID_1', NULL, 'skyline', 'project_inventory', 'inventory_ID', 1, 1, 'skyline', 'inventory', 'inventory_ID'),
(NULL, 'skyline', 'fk_project_ID_1', NULL, 'skyline', 'project_inventory', 'project_ID', 1, 1, 'skyline', 'project', 'project_ID'),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'supplier', 'supplier_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'skyline', 'PRIMARY', NULL, 'skyline', 'user', 'user_ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'studentdatabase', 'PRIMARY', NULL, 'studentdatabase', 'student', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'userdatabase', 'PRIMARY', NULL, 'userdatabase', 'user', 'userid', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, NULL, '', '', NULL),
(NULL, 'bbc', 'employee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2025-03-06 13:52:46', NULL, NULL, NULL, '', '', NULL),
(NULL, 'bbcb', 'employee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2025-03-13 14:22:36', NULL, NULL, NULL, '', '', NULL),
(NULL, 'brightminds', 'contact', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2025-04-22 19:53:03', NULL, NULL, NULL, '', '', NULL),
(NULL, 'brightminds', 'minds', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 37, 442, 16384, NULL, 0, 0, '2025-04-22 19:53:04', NULL, NULL, NULL, '', '', NULL),
(NULL, 'coffewebsitedb', 'messages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 40, 40, 281474976710655, 2048, 0, '2025-04-22 10:37:23', '2025-04-22 10:40:46', NULL, NULL, '', '', NULL),
(NULL, 'coffewebsitedb', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 41, 412, 281474976710655, 2048, 0, '2025-04-22 09:58:35', '2025-05-08 17:19:07', NULL, NULL, '', '', NULL),
(NULL, 'demo', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2025-03-20 14:51:11', NULL, NULL, NULL, '', '', NULL),
(NULL, 'employeedatabase', 'employee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2025-03-16 09:35:00', '2025-03-16 09:40:42', NULL, NULL, '', '', NULL),
(NULL, 'farmer_management', 'advisory_logs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-08-03 19:37:10', '2025-08-03 19:37:10', NULL, NULL, '', '', NULL),
(NULL, 'farmer_management', 'crops', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 53, 160, 281474976710655, 3072, 0, '2025-08-03 19:37:10', '2025-08-03 19:37:10', NULL, NULL, '', '', NULL),
(NULL, 'farmer_management', 'farmers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 102, 204, 281474976710655, 3072, 0, '2025-08-03 19:37:09', '2025-08-03 19:37:10', NULL, NULL, '', '', NULL),
(NULL, 'freshmartdb', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2025-05-11 07:27:41', NULL, NULL, NULL, '', '', NULL),
(NULL, 'freshmartdb', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2025-05-10 18:21:51', NULL, NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'availability_status', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 20, 40, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'booking_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 80, 160, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'facilities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, 36, 732, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_descriptions', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 108, 216, 281474976710655, 3072, 0, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_drafts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_facilities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 18, 216, 5066549580791807, 4096, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_locations', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 102, 204, 281474976710655, 3072, 0, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_payment_methods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 5066549580791807, 1024, 0, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_photos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostel_rooms', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 73, 292, 281474976710655, 4096, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'hostels', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 46, 92, 281474976710655, 3072, 0, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'inquiries', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 72, 144, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'owners', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 54, 108, 281474976710655, 5120, 0, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'payment_methods', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 50, 300, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'reviews', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 46, 92, 281474976710655, 3072, 0, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'room_types', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 60, 360, 281474976710655, 3072, 0, '2025-06-29 08:40:13', '2025-06-29 08:49:56', NULL, NULL, '', '', NULL),
(NULL, 'hostel_system', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 100, 100, 281474976710655, 6144, 0, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, NULL, '', '', NULL),
(NULL, 'mubs_db', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 20, 80, 281474976710655, 2048, 0, '2025-03-30 18:24:51', '2025-03-31 03:52:43', NULL, NULL, '', '', NULL),
(NULL, 'mubsdb', 'students', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 58, 176, 281474976710655, 4096, 0, '2025-04-30 18:12:46', '2025-05-07 16:04:04', '2025-04-30 18:12:46', NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', '2008-11-14 20:31:32', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 450, 197, 88650, 55450570411999231, 16384, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 975, 9, 8775, 2533274790395903, 16384, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 497, 812, 403852, 281474976710655, 20480, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 152, 281474976710655, 2048, 48, '2008-11-14 20:31:31', '2009-03-06 18:08:32', NULL, NULL, '', '', NULL),
(NULL, 'regform', 'reglist', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 44, 220, 281474976710655, 2048, 176, '2025-03-10 16:58:18', '2025-03-17 16:34:05', NULL, NULL, '', '', NULL),
(NULL, 'registerform', 'register', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2025-05-09 17:07:58', NULL, NULL, NULL, '', '', NULL),
(NULL, 'registration', 'details', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2025-04-25 13:40:03', NULL, NULL, NULL, '', '', NULL),
(NULL, 'registration', 'logging', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2025-04-25 16:30:14', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'completed_courses', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 16, 32, 4503599627370495, 4096, 0, '2025-04-12 06:40:32', '2025-04-23 02:34:19', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'course_outline', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 44, 70, 3092, 281474976710655, 3072, 0, '2025-04-07 00:40:36', '2025-04-24 06:05:00', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'courses', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 168, 1344, 281474976710655, 2048, 0, '2025-04-05 20:46:19', '2025-04-24 08:39:11', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'current_course_page', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 17, 17, 4785074604081151, 2048, 0, '2025-04-07 13:18:55', '2025-04-24 08:31:59', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'enrollments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 17, 102, 4785074604081151, 4096, 0, '2025-04-11 06:06:06', '2025-04-24 06:05:16', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'messages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 50, 152, 281474976710655, 2048, 0, '2025-04-23 02:48:26', '2025-04-24 08:40:54', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'notes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 253, 338, 85644, 281474976710655, 14336, 0, '2025-04-07 01:28:50', '2025-04-24 06:36:22', NULL, NULL, '', '', NULL),
(NULL, 'skillquest', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 51, 444, 281474976710655, 3072, 136, '2025-04-18 20:13:28', '2025-04-24 08:35:58', NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2025-03-25 16:18:15', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'employee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2025-04-17 06:52:43', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'inventory', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2025-04-15 08:04:23', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'inventory_orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 0, '2025-03-26 21:42:00', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'inventory_supplier', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 0, '2025-03-25 16:18:17', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 0, '2025-04-15 14:59:37', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'project', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2025-03-25 16:18:18', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'project_inventory', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2025-04-14 16:23:14', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'supplier', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2025-03-25 16:18:16', NULL, NULL, NULL, '', '', NULL),
(NULL, 'skyline', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 37, 264, 281474976710655, 2048, 0, '2025-04-17 15:32:47', '2025-04-17 15:35:24', NULL, NULL, '', '', NULL),
(NULL, 'studentdatabase', 'student', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2025-03-12 04:54:55', NULL, NULL, NULL, '', '', NULL),
(NULL, 'userdatabase', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, 21, 320, 281474976710655, 2048, 0, '2025-04-10 15:38:49', '2025-05-10 06:45:42', NULL, NULL, '', '', NULL);
...
(15, 'root', 'localhost:49985', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'skyline', 'project_ID', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'employee', 'project'),
(NULL, 'skyline', 'FK_inventory_orders_1', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'inventory_orders', 'inventory'),
(NULL, 'skyline', 'FK_inventory_orders_2', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'inventory_orders', 'orders'),
(NULL, 'skyline', 'fk_inventory_ID', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'inventory_supplier', 'inventory'),
(NULL, 'skyline', 'fk_supplier_ID', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'inventory_supplier', 'supplier'),
(NULL, 'skyline', 'fk_orders', NULL, 'skyline', 'PRIMARY', 'NONE', 'RESTRICT', 'CASCADE', 'orders', 'supplier'),
(NULL, 'skyline', 'customer_ID', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'project', 'customer'),
(NULL, 'skyline', 'fk_inventory_ID_1', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'project_inventory', 'inventory'),
(NULL, 'skyline', 'fk_project_ID_1', NULL, 'skyline', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'project_inventory', 'project');
...
(NULL, 'bbc', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'bbcb', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'brightminds', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'coffewebsitedb', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'demo', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'employeedatabase', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'farmer_management', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'freshmartdb', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'hostel_system', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mubs_db', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mubsdb', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'regform', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'registerform', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'registration', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'skillquest', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'skyline', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'studentdatabase', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'userdatabase', 'latin1', 'latin1_swedish_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '3'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '16893'),
('INNODB_BUFFER_POOL_READS', '26'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
...
(NULL, 'bbc', 'employee', 0, 'bbc', 'PRIMARY', 1, 'EmpID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'bbcb', 'employee', 0, 'bbcb', 'PRIMARY', 1, 'EmpID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'brightminds', 'contact', 0, 'brightminds', 'PRIMARY', 1, 'UserID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'brightminds', 'minds', 0, 'brightminds', 'PRIMARY', 1, 'UserID', 'A', 37, NULL, NULL, '', 'BTREE', ''),
(NULL, 'coffewebsitedb', 'messages', 0, 'coffewebsitedb', 'PRIMARY', 1, 'messageid', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'coffewebsitedb', 'users', 0, 'coffewebsitedb', 'PRIMARY', 1, 'userid', 'A', 10, NULL, NULL, '', 'BTREE', ''),
(NULL, 'demo', 'user', 0, 'demo', 'PRIMARY', 1, 'userID', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'employeedatabase', 'employee', 0, 'employeedatabase', 'PRIMARY', 1, 'emp_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'advisory_logs', 0, 'farmer_management', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'advisory_logs', 1, 'farmer_management', 'farmer_id', 1, 'farmer_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'advisory_logs', 1, 'farmer_management', 'crop_id', 1, 'crop_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'crops', 0, 'farmer_management', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'crops', 1, 'farmer_management', 'farmer_id', 1, 'farmer_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'farmers', 0, 'farmer_management', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'farmer_management', 'farmers', 0, 'farmer_management', 'email', 1, 'email', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'freshmartdb', 'products', 0, 'freshmartdb', 'PRIMARY', 1, 'productNo', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'freshmartdb', 'users', 0, 'freshmartdb', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'availability_status', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'availability_status', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'booking_info', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'booking_info', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'facilities', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 20, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'facilities', 0, 'hostel_system', 'name', 1, 'name', 'A', 20, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_drafts', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_drafts', 1, 'hostel_system', 'owner_id', 1, 'owner_id', 'A', NULL, NULL, NULL, 'YES', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_facilities', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 12, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_facilities', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_facilities', 1, 'hostel_system', 'facility_id', 1, 'facility_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_locations', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_locations', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 1, 'hostel_system', 'payment_method_id', 1, 'payment_method_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_photos', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_photos', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_rooms', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_rooms', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostel_rooms', 1, 'hostel_system', 'room_type_id', 1, 'room_type_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostels', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'hostels', 1, 'hostel_system', 'owner_id', 1, 'owner_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'inquiries', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'inquiries', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'owners', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'owners', 0, 'hostel_system', 'email', 1, 'email', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'payment_methods', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'payment_methods', 0, 'hostel_system', 'name', 1, 'name', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'reviews', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'reviews', 1, 'hostel_system', 'hostel_id', 1, 'hostel_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'room_types', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'room_types', 0, 'hostel_system', 'name', 1, 'name', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'users', 0, 'hostel_system', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'users', 0, 'hostel_system', 'username', 1, 'username', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'hostel_system', 'users', 0, 'hostel_system', 'email', 1, 'email', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mubs_db', 'user', 0, 'mubs_db', 'PRIMARY', 1, 'userid', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mubsdb', 'students', 0, 'mubsdb', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mubsdb', 'students', 1, 'mubsdb', 'student_email', 1, 'student_email', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mubsdb', 'students', 1, 'mubsdb', 'student_reg_no', 1, 'student_reg_no', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'regform', 'reglist', 0, 'regform', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'registerform', 'register', 0, 'registerform', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'registration', 'details', 0, 'registration', 'PRIMARY', 1, 'ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'registration', 'logging', 0, 'registration', 'PRIMARY', 1, 'name', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'completed_courses', 0, 'skillquest', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'completed_courses', 1, 'skillquest', 'user_id', 1, 'user_id', 'A', NULL, NULL, NULL, 'YES', 'BTREE', ''),
(NULL, 'skillquest', 'completed_courses', 1, 'skillquest', 'course_id', 1, 'course_id', 'A', NULL, NULL, NULL, 'YES', 'BTREE', ''),
(NULL, 'skillquest', 'course_outline', 0, 'skillquest', 'PRIMARY', 1, 'outline_id', 'A', 44, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'course_outline', 1, 'skillquest', 'course_id', 1, 'course_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'courses', 0, 'skillquest', 'PRIMARY', 1, 'course_id', 'A', 8, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'current_course_page', 0, 'skillquest', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'enrollments', 0, 'skillquest', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'enrollments', 0, 'skillquest', 'user_id', 1, 'user_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'enrollments', 0, 'skillquest', 'user_id', 2, 'course_id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'enrollments', 1, 'skillquest', 'course_id', 1, 'course_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'messages', 0, 'skillquest', 'PRIMARY', 1, 'messageid', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'notes', 0, 'skillquest', 'PRIMARY', 1, 'note_id', 'A', 253, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'notes', 1, 'skillquest', 'outline_id', 1, 'outline_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'notes', 1, 'skillquest', 'course_id', 1, 'course_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'users', 0, 'skillquest', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skillquest', 'users', 0, 'skillquest', 'email', 1, 'email', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'customer', 0, 'skyline', 'PRIMARY', 1, 'customer_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'employee', 0, 'skyline', 'PRIMARY', 1, 'employee_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'employee', 1, 'skyline', 'project_ID', 1, 'project_ID', 'A', 1, NULL, NULL, 'YES', 'BTREE', ''),
(NULL, 'skyline', 'inventory', 0, 'skyline', 'PRIMARY', 1, 'inventory_ID', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_orders', 0, 'skyline', 'PRIMARY', 1, 'order_ID', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_orders', 0, 'skyline', 'PRIMARY', 2, 'inventory_ID', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_orders', 1, 'skyline', 'FK_inventory_orders_1', 1, 'inventory_ID', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_supplier', 0, 'skyline', 'PRIMARY', 1, 'inventory_ID', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_supplier', 0, 'skyline', 'PRIMARY', 2, 'supplier_ID', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'inventory_supplier', 1, 'skyline', 'fk_supplier_ID', 1, 'supplier_ID', 'A', 2, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'orders', 0, 'skyline', 'PRIMARY', 1, 'order_ID', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'orders', 1, 'skyline', 'fk_orders', 1, 'supplier_ID', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'project', 0, 'skyline', 'PRIMARY', 1, 'project_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'project', 1, 'skyline', 'customer_ID', 1, 'customer_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'project_inventory', 0, 'skyline', 'PRIMARY', 1, 'inventory_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'project_inventory', 0, 'skyline', 'PRIMARY', 2, 'project_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'project_inventory', 1, 'skyline', 'fk_project_ID_1', 1, 'project_ID', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'supplier', 0, 'skyline', 'PRIMARY', 1, 'supplier_ID', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'skyline', 'user', 0, 'skyline', 'PRIMARY', 1, 'user_ID', 'A', 7, NULL, NULL, '', 'BTREE', ''),
(NULL, 'studentdatabase', 'student', 0, 'studentdatabase', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
(NULL, 'userdatabase', 'user', 0, 'userdatabase', 'PRIMARY', 1, 'userid', 'A', 15, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-09-06 06:56:11', '2025-09-06 06:56:11', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'bbc', 'employee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 3, '2025-03-06 13:52:46', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'bbcb', 'employee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 3, '2025-03-13 14:22:36', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'brightminds', 'contact', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 2, '2025-04-22 19:53:03', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'brightminds', 'minds', 'BASE TABLE', 'InnoDB', 10, 'Compact', 37, 442, 16384, 0, 0, 3145728, 38, '2025-04-22 19:53:04', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'coffewebsitedb', 'messages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 40, 40, 281474976710655, 2048, 0, 2, '2025-04-22 10:37:23', '2025-04-22 10:40:46', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'coffewebsitedb', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 41, 412, 281474976710655, 2048, 0, 14, '2025-04-22 09:58:35', '2025-05-08 17:19:07', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'demo', 'user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 3145728, 4, '2025-03-20 14:51:11', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'employeedatabase', 'employee', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, 2, '2025-03-16 09:35:00', '2025-03-16 09:40:42', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'farmer_management', 'advisory_logs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2025-08-03 19:37:10', '2025-08-03 19:37:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'farmer_management', 'crops', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 53, 160, 281474976710655, 3072, 0, 4, '2025-08-03 19:37:10', '2025-08-03 19:37:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'farmer_management', 'farmers', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 102, 204, 281474976710655, 3072, 0, 3, '2025-08-03 19:37:09', '2025-08-03 19:37:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'freshmartdb', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 3145728, 3, '2025-05-11 07:27:41', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'freshmartdb', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 3145728, 3, '2025-05-10 18:21:51', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'availability_status', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 20, 40, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'booking_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 80, 160, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'facilities', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 20, 36, 732, 281474976710655, 3072, 0, 21, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_descriptions', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 108, 216, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_drafts', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_facilities', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 12, 18, 216, 5066549580791807, 4096, 0, 13, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_locations', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 102, 204, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_payment_methods', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 5066549580791807, 1024, 0, 1, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_photos', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2025-06-29 08:40:14', '2025-06-29 08:40:14', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostel_rooms', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 73, 292, 281474976710655, 4096, 0, 5, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'hostels', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 46, 92, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'inquiries', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 72, 144, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'owners', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 54, 108, 281474976710655, 5120, 0, 3, '2025-06-29 08:40:13', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'payment_methods', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 50, 300, 281474976710655, 3072, 0, 7, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'reviews', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 46, 92, 281474976710655, 3072, 0, 3, '2025-06-29 08:40:14', '2025-06-29 08:50:27', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'room_types', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 60, 360, 281474976710655, 3072, 0, 7, '2025-06-29 08:40:13', '2025-06-29 08:49:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'hostel_system', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 100, 100, 281474976710655, 6144, 0, 2, '2025-06-29 08:40:14', '2025-06-29 08:49:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mubs_db', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 20, 80, 281474976710655, 2048, 0, 5, '2025-03-30 18:24:51', '2025-03-31 03:52:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mubsdb', 'students', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 58, 176, 281474976710655, 4096, 0, 4, '2025-04-30 18:12:46', '2025-05-07 16:04:04', '2025-04-30 18:12:46', 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', '2008-11-14 20:31:32', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 450, 197, 88650, 55450570411999231, 16384, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 975, 9, 8775, 2533274790395903, 16384, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 497, 812, 403852, 281474976710655, 20480, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2008-11-14 20:31:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-11-14 20:31:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 152, 281474976710655, 2048, 48, NULL, '2008-11-14 20:31:31', '2009-03-06 18:08:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'regform', 'reglist', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 44, 220, 281474976710655, 2048, 176, 6, '2025-03-10 16:58:18', '2025-03-17 16:34:05', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'registerform', 'register', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 3145728, 1, '2025-05-09 17:07:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'registration', 'details', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 2, '2025-04-25 13:40:03', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'registration', 'logging', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 3145728, 1, '2025-04-25 16:30:14', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'completed_courses', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 16, 32, 4503599627370495, 4096, 0, 3, '2025-04-12 06:40:32', '2025-04-23 02:34:19', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'course_outline', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 44, 70, 3092, 281474976710655, 3072, 0, 46, '2025-04-07 00:40:36', '2025-04-24 06:05:00', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'courses', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 168, 1344, 281474976710655, 2048, 0, 9, '2025-04-05 20:46:19', '2025-04-24 08:39:11', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'current_course_page', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 17, 17, 4785074604081151, 2048, 0, 2, '2025-04-07 13:18:55', '2025-04-24 08:31:59', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'enrollments', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 6, 17, 102, 4785074604081151, 4096, 0, 9, '2025-04-11 06:06:06', '2025-04-24 06:05:16', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'messages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 50, 152, 281474976710655, 2048, 0, 4, '2025-04-23 02:48:26', '2025-04-24 08:40:54', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'notes', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 253, 338, 85644, 281474976710655, 14336, 0, 254, '2025-04-07 01:28:50', '2025-04-24 06:36:22', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skillquest', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 51, 444, 281474976710655, 3072, 136, 13, '2025-04-18 20:13:28', '2025-04-24 08:35:58', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'customer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 3145728, 26, '2025-03-25 16:18:15', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'employee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 3145728, 2, '2025-04-17 06:52:43', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'inventory', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 3145728, 19, '2025-04-15 08:04:23', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'inventory_orders', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 3145728, NULL, '2025-03-26 21:42:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'inventory_supplier', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 3145728, NULL, '2025-03-25 16:18:17', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'orders', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 3145728, 101, '2025-04-15 14:59:37', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'project', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 3145728, 15, '2025-03-25 16:18:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'project_inventory', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 3145728, NULL, '2025-04-14 16:23:14', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'supplier', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 3145728, 97, '2025-03-25 16:18:16', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'skyline', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 37, 264, 281474976710655, 2048, 0, 8, '2025-04-17 15:32:47', '2025-04-17 15:35:24', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'studentdatabase', 'student', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 3145728, 6, '2025-03-12 04:54:55', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'userdatabase', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 15, 21, 320, 281474976710655, 2048, 0, 19, '2025-04-10 15:38:49', '2025-05-10 06:45:42', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'bbc', 'PRIMARY', 'bbc', 'employee', 'PRIMARY KEY'),
(NULL, 'bbcb', 'PRIMARY', 'bbcb', 'employee', 'PRIMARY KEY'),
(NULL, 'brightminds', 'PRIMARY', 'brightminds', 'contact', 'PRIMARY KEY'),
(NULL, 'brightminds', 'PRIMARY', 'brightminds', 'minds', 'PRIMARY KEY'),
(NULL, 'coffewebsitedb', 'PRIMARY', 'coffewebsitedb', 'messages', 'PRIMARY KEY'),
(NULL, 'coffewebsitedb', 'PRIMARY', 'coffewebsitedb', 'users', 'PRIMARY KEY'),
(NULL, 'demo', 'PRIMARY', 'demo', 'user', 'PRIMARY KEY'),
(NULL, 'employeedatabase', 'PRIMARY', 'employeedatabase', 'employee', 'PRIMARY KEY'),
(NULL, 'farmer_management', 'PRIMARY', 'farmer_management', 'advisory_logs', 'PRIMARY KEY'),
(NULL, 'farmer_management', 'PRIMARY', 'farmer_management', 'crops', 'PRIMARY KEY'),
(NULL, 'farmer_management', 'PRIMARY', 'farmer_management', 'farmers', 'PRIMARY KEY'),
(NULL, 'farmer_management', 'email', 'farmer_management', 'farmers', 'UNIQUE'),
(NULL, 'freshmartdb', 'PRIMARY', 'freshmartdb', 'products', 'PRIMARY KEY'),
(NULL, 'freshmartdb', 'PRIMARY', 'freshmartdb', 'users', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'availability_status', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'booking_info', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'facilities', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'name', 'hostel_system', 'facilities', 'UNIQUE'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_descriptions', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_drafts', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_facilities', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_locations', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_payment_methods', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_photos', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostel_rooms', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'hostels', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'inquiries', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'owners', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'email', 'hostel_system', 'owners', 'UNIQUE'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'payment_methods', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'name', 'hostel_system', 'payment_methods', 'UNIQUE'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'reviews', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'room_types', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'name', 'hostel_system', 'room_types', 'UNIQUE'),
(NULL, 'hostel_system', 'PRIMARY', 'hostel_system', 'users', 'PRIMARY KEY'),
(NULL, 'hostel_system', 'username', 'hostel_system', 'users', 'UNIQUE'),
(NULL, 'hostel_system', 'email', 'hostel_system', 'users', 'UNIQUE'),
(NULL, 'mubs_db', 'PRIMARY', 'mubs_db', 'user', 'PRIMARY KEY'),
(NULL, 'mubsdb', 'PRIMARY', 'mubsdb', 'students', 'PRIMARY KEY'),
...
(NULL, 'regform', 'PRIMARY', 'regform', 'reglist', 'PRIMARY KEY'),
(NULL, 'registerform', 'PRIMARY', 'registerform', 'register', 'PRIMARY KEY'),
(NULL, 'registration', 'PRIMARY', 'registration', 'details', 'PRIMARY KEY'),
(NULL, 'registration', 'PRIMARY', 'registration', 'logging', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'completed_courses', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'course_outline', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'courses', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'current_course_page', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'enrollments', 'PRIMARY KEY'),
(NULL, 'skillquest', 'user_id', 'skillquest', 'enrollments', 'UNIQUE'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'messages', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'notes', 'PRIMARY KEY'),
(NULL, 'skillquest', 'PRIMARY', 'skillquest', 'users', 'PRIMARY KEY'),
(NULL, 'skillquest', 'email', 'skillquest', 'users', 'UNIQUE'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'customer', 'PRIMARY KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'employee', 'PRIMARY KEY'),
(NULL, 'skyline', 'project_ID', 'skyline', 'employee', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'inventory', 'PRIMARY KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'inventory_orders', 'PRIMARY KEY'),
(NULL, 'skyline', 'FK_inventory_orders_1', 'skyline', 'inventory_orders', 'FOREIGN KEY'),
(NULL, 'skyline', 'FK_inventory_orders_2', 'skyline', 'inventory_orders', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'inventory_supplier', 'PRIMARY KEY'),
(NULL, 'skyline', 'fk_inventory_ID', 'skyline', 'inventory_supplier', 'FOREIGN KEY'),
(NULL, 'skyline', 'fk_supplier_ID', 'skyline', 'inventory_supplier', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'orders', 'PRIMARY KEY'),
(NULL, 'skyline', 'fk_orders', 'skyline', 'orders', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'project', 'PRIMARY KEY'),
(NULL, 'skyline', 'customer_ID', 'skyline', 'project', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'project_inventory', 'PRIMARY KEY'),
(NULL, 'skyline', 'fk_inventory_ID_1', 'skyline', 'project_inventory', 'FOREIGN KEY'),
(NULL, 'skyline', 'fk_project_ID_1', 'skyline', 'project_inventory', 'FOREIGN KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'supplier', 'PRIMARY KEY'),
(NULL, 'skyline', 'PRIMARY', 'skyline', 'user', 'PRIMARY KEY'),
(NULL, 'studentdatabase', 'PRIMARY', 'studentdatabase', 'student', 'PRIMARY KEY'),
(NULL, 'userdatabase', 'PRIMARY', 'userdatabase', 'user', 'PRIMARY KEY');
...
-- Database: `mubs_db`
--
CREATE DATABASE `mubs_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mubs_db`;
...
-- Database: `mubsdb`
--
CREATE DATABASE `mubsdb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mubsdb`;
...
INSERT INTO `students` (`id`, `student_name`, `student_reg_no`, `student_age`, `student_email`) VALUES
(1, 'Julius', '23/11997/PS', 20, 'julius@gmail.com'),
(2, 'Thomas', '23/11117/PS', 23, 'thomas@gmail.com'),
(3, 'Mr.iga gatare', '23007047878', 16, 'iga@gmail.com');
--
-- Database: `mysql`
--
...
-- Database: `regform`
--
CREATE DATABASE `regform` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `regform`;
...
INSERT INTO `reglist` (`id`, `name`, `email`, `message`) VALUES
(1, 'Julius', 'julius082115@gmail.com', '1234');
--
-- Database: `registerform`
--
CREATE DATABASE `registerform` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `registerform`;
...
-- Database: `skillquest`
--
CREATE DATABASE `skillquest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `skillquest`;
...
INSERT INTO `completed_courses` (`id`, `user_id`, `course_id`, `completion_date`) VALUES
(1, 1, 1, '2025-04-13'),
(2, 1, 2, '2025-04-23');
...
INSERT INTO `course_outline` (`outline_id`, `course_id`, `module_number`, `module_title`, `module_link`) VALUES
(1, 1, 1, 'Module 1: Intro to HTML', 'html lesson 1.html'),
(2, 1, 2, 'Module 2: Basic HTML Elements', 'html lesson 2.html'),
(3, 1, 3, 'Module 3: Links and Navigation', 'html lesson 3.html'),
(4, 1, 4, 'Module 4: Images and Multimedia', 'html lesson 4.html'),
(5, 1, 5, 'Module 5: Lists and Tables', 'html lesson 5.html'),
(6, 1, 6, 'Module 6: Forms and Input Elements', 'html lesson 6.html'),
(7, 1, 7, 'Module 7: HTML5 Semantic Elements', 'html lesson 7.html'),
(8, 1, 8, 'Module 8: Building a Simple Webpage', 'html lesson 8.html'),
(9, 1, 9, 'Module 9: Simple HTML Project Ideas', 'html lesson 9.html'),
(18, 3, 1, 'Module 1: Introduction to Python', 'python lesson 1.html'),
(10, 2, 1, 'Module 1: Introduction to CSS', 'css lesson 1.html'),
(11, 2, 2, 'Module 2: CSS Box Model', 'css lesson 2.html'),
(12, 2, 3, 'Module 3: Colors, Background and Borders', 'css lesson 3.html'),
(13, 2, 4, 'Module 4:Typology and Text Styling', 'css lesson 4.html'),
(14, 2, 5, 'Module 5: CSS Layout Techniques', 'css lesson 5.html'),
(15, 2, 6, 'Module 6: Responsive Design and Layout Techniques', 'css lesson 6.html'),
(16, 2, 7, 'Module 7: CSS Project ideas', 'css lesson 7.html'),
(19, 3, 2, 'Module 2: Basics of Python Programming', 'python lesson 2.html'),
(20, 3, 3, 'Module 3: Control flow', 'python lesson 3.html'),
(21, 3, 4, 'Module 4: Functions', 'python lesson 4.html'),
(22, 3, 5, 'Module 5: Data Structures', 'python lesson 5.html'),
(23, 3, 6, 'Module 6: File Handling', 'python lesson 6.html'),
(24, 3, 7, 'Module 7:: Error Handling', 'python lesson 7.html'),
(25, 3, 8, 'Module 8: Object-Oriented Programming(OOP)', 'python lesson 8.html'),
(26, 3, 9, 'Module 9: Final Project and Review', 'python lesson 9.html'),
(27, 4, 1, 'Introduction to Java and Development Setup', 'java lesson 1.html'),
(28, 4, 2, 'Variables, Data Types, and Operators', 'java lesson 2.html'),
(29, 4, 3, 'Control Flow Statements', 'java lesson 3.html'),
(30, 4, 4, 'Methods and Functions', 'java lesson 4.html'),
(31, 4, 5, 'Arrays and Strings', 'java lesson 5.html'),
(32, 4, 6, 'Object-Oriented Programming (OOP) in Java', 'java lesson 6.html'),
(33, 4, 7, 'More on OOP - Inheritance, Polymorphism, and Encapsulation', 'java lesson 7.html'),
(34, 4, 8, 'Exception Handling and File I/O', 'java lesson 8.html'),
(35, 4, 9, 'Simple Java Project ideas', 'java lesson 9.html'),
(36, 5, 1, 'Introduction to jQuery', 'jquery lesson 1.html'),
(37, 5, 2, 'Basics of jQuery', 'jquery lesson 2.html'),
(38, 5, 3, 'jQuery Events', 'jquery lesson 3.html'),
(39, 5, 4, 'jQuery Effects', 'jquery lesson 4.html'),
(40, 5, 5, 'jQuery HTML', 'jquery lesson 5.html'),
(41, 5, 6, 'jQuery CSS', 'jquery lesson 6.html'),
(42, 8, 1, 'SQL Introduction', 'sqlintroduction.html'),
(43, 8, 2, 'SQL Plus Tools', 'sql plus tools.html'),
(44, 8, 3, 'Querying', 'querying.html'),
(45, 8, 4, 'Commands', 'commands.html');
...
INSERT INTO `courses` (`course_id`, `course_title`, `course_description`, `course_image_url`, `language`, `rating`, `created_at`, `updated_at`) VALUES
(1, 'Mastering HTML', 'Learn the fundamentals and best practices of HTML to build modern web pages.', 'assets/images/html.jpg', 'HTML', 5, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(2, 'CSS for Beginners', 'Understand how to style your web pages beautifully using CSS.', 'assets/images/css.jpg', 'CSS', 4, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(3, 'Python Programming', 'Dive into Python programming with hands-on examples and projects.', 'assets/images/python.jpg', 'Python', 5, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(4, 'Java Fundamentals', 'Explore object-oriented programming using Java for desktop and web apps.', 'assets/images/java.jpg', 'Java', 5, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(5, 'jQuery Crash Course', 'Enhance your JavaScript skills with jQuery to build interactive web applications.', 'assets/images/jquery.gif', 'jQuery', 4, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(6, 'Responsive Design with Bootstrap 5', 'Build mobile-first responsive websites using Bootstrap 5.', 'assets/images/bootstrap 5.png', 'Bootstrap 5', 5, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(7, 'VB.NET for Windows Apps', 'Create Windows applications using VB.NET', 'assets/images/vb.jpg', 'VB.NET', 4, '2025-04-05 20:53:25', '2025-04-05 20:53:25'),
(8, 'SQL Fundamentals', 'Learn the essentials of SQL for database management and querying', 'assets/images/sql.jpg', 'SQL', 5, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `current_course_page`
--

CREATE TABLE IF NOT EXISTS `current_course_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `course_id` int(11) NOT NULL,
...
--
-- Dumping data for table `current_course_page`
--

INSERT INTO `current_course_page` (`id`, `course_id`, `outline_id`, `module_number`) VALUES
(1, 1, 1, 1);
...
(1, 1, 1, '2025-04-11 10:06:17'),
(4, 1, 2, '2025-04-23 01:07:37'),
(5, 1, 3, '2025-04-23 01:08:37'),
(6, 1, 4, '2025-04-24 03:54:57'),
(7, 1, 5, '2025-04-24 05:20:21'),
(8, 1, 8, '2025-04-24 06:05:16');
...
INSERT INTO `messages` (`messageid`, `name`, `email`, `message`) VALUES
(1, 'Julius', 'mukubyajulius@gmail.com', 'too much work'),
(2, 'Julius', 'mukubyajulius@gmail.com', 'test12'),
(3, 'Julius', 'mukubyajulius@gmail.com', 'test123');
...
INSERT INTO `notes` (`note_id`, `course_id`, `outline_id`, `section_title`, `section_content`) VALUES
(1, 1, 1, 'What is HTML?', 'HTML (HyperText Markup Language) is the standard language used to create web pages. It provides the structure for a webpage by defining elements such as headings, paragraphs, links, images, and other media. HTML works with CSS (for styling) and JavaScript (for functionality) to create complete web applications.'),
(2, 1, 1, 'How Does the Web Work?', 'Web browsers (like Chrome, Firefox, and Safari) are programs that display web pages. Web servers are computers that host websites and respond to requests from browsers. A web page is displayed in a browser after the browser sends a request to the web server (using a URL), and the server responds by sending back the requested HTML document.'),
(3, 1, 1, 'Browsers, Web Servers, and Displaying Websites', 'A browser interprets the HTML, CSS, and JavaScript of a webpage to display content to the user, while web servers store website files and deliver them upon request. When a user enters a web address (URL) in the browser, the browser sends an HTTP request to the web server. The server then responds with the appropriate HTML file, which the browser reads and renders, allowing the user to view the webpage.'),
(4, 1, 1, 'Understanding HTML Documents and Basic Structure', 'The DOCTYPE declaration (e.g., <!DOCTYPE html>) specifies the HTML version, such as HTML5. The <html> element serves as the root of the document, containing all other elements. Within it, the <head> element includes metadata like character encoding (<meta>), the page title (<title>), and links to external resources such as stylesheets (<link>). The <body> element holds the visible content of the webpage, including headings (<h1> to <h6>), paragraphs (<p>), links (<a>), images (<img>), and sections or containers (<div>).'),
(5, 1, 2, '1. Headings (h1 - h6)', 'HTML provides six levels of headings, numbered from <h1> to <h6>. <h1> is the largest and most important heading, while <h6> is the smallest.\n\nExample:\n<h1>This is Heading 1</h1>\n<h2>This is Heading 2</h2>\n<h6>This is Heading 6</h6>'),
(6, 1, 2, '2. Paragraphs (p)', 'The <p> tag is used to define paragraphs in HTML. It automatically adds some space above and below the text.\n\nExample:\n<p>This is a paragraph of text.</p>'),
(7, 1, 2, '3. Line Breaks (br)', 'The <br> tag inserts a line break without starting a new paragraph. It is an empty tag, meaning it doesn''t require a closing tag.\n\nExample:\nLine 1<br>Line 2'),
(8, 1, 2, '4. Horizontal Rules (hr)', 'The <hr> tag is used to insert a horizontal line or divider between sections of content. Like <br>, it is also an empty tag.\n\nExample:\n<hr>'),
(9, 1, 2, '5. Emphasizing Text - Bold (strong, b)', '<strong> indicates important text with emphasis, usually displayed as bold. <b> makes text bold without any additional meaning.\n\nExample:\n<strong>This is important text.</strong>\n<b>This is bold text.</b>'),
(10, 1, 2, '5. Emphasizing Text - Italic (em, i)', '<em> marks text with emphasis, usually displayed in italics. <i> italicizes text without additional emphasis.\n\nExample:\n<em>This text has emphasis.</em>\n<i>This text is in italics.</i>'),
(11, 1, 2, 'Conclusion', 'These elements are essential building blocks for creating web content.'),
(12, 1, 3, '1. Anchor Tags', 'The anchor (<a>) tag is used to create hyperlinks in HTML, allowing users to navigate to other web pages or resources. The href attribute defines the destination URL of the link. For example, the syntax <a href="https://www.example.com">Visit Example</a> creates a clickable link that directs users to "https://www.example.com" when clicked.'),
(13, 1, 3, '2. Creating Internal and External Links', 'Internal Links:\nLinks that navigate within the same website or domain. Usually, these links point to another page on the same site or to a specific section within the current page.\n\nExample:\n<a href="about.html">About Us</a>\n\nLinks to Sections (Using Anchors):\nExample:\n<a href="#section1">Go to Section 1</a>\n\nThe section to be linked should have an id:\n<h2 id="section1">Section 1</h2>\n\nExternal Links:\nLinks that navigate to other websites or domains.\n\nExample:\n<a href="https://www.google.com">Visit Google</a>'),
(14, 1, 3, '3. Target Attributes (Opening Links in a New Tab)', 'The target attribute specifies where to open the linked document.\n\nOpening Links in a New Tab:\nExample:\n<a href="https://www.example.com" target="_blank">Open in New Tab</a>\n\nAdditional Attributes:\nThe rel="noopener noreferrer" attribute is often added to external links that open in a new tab for security purposes.\n\nExample:\n<a href="https://www.example.com" target="_blank" rel="noopener noreferrer">Secure External Link</a>'),
(15, 1, 4, '1. Inserting Images (<img> tag)', 'The <img> tag is used to insert images into a webpage.\n\nBasic syntax:\n<img src="image_url" alt="description">\n\n- src: Specifies the path or URL of the image.\n- alt: Provides alternative text for the image (important for accessibility and SEO).'),
(16, 1, 4, '2. Image Attributes', 'width and height: These attributes define the image''s size.\n\nYou can set the dimensions in pixels (px), percentage (%), etc.\nExample:\n<img src="image_url" alt="description" width="300" height="200">\n\nNote: It''s better to maintain the aspect ratio of the image to prevent distortion.'),
(17, 1, 4, '3. Introduction to Embedding Multimedia', 'a. Embedding Audio:\nYou can embed audio files using the <audio> tag.\n\nBasic syntax:\n<audio controls>\n    <source src="audio_file.mp3" type="audio/mpeg">\n    Your browser does not support the audio element.\n</audio>\n\n- controls: Adds audio controls like play, pause, and volume.\n- You can embed different formats using multiple <source> tags for compatibility.\n\nb. Embedding Video:\nThe <video> tag allows you to embed video files.\n\nBasic syntax:\n<video controls width="400">\n    <source src="video_file.mp4" type="video/mp4">\n    Your browser does not support the video tag.\n</video>\n\n- controls: Adds video controls (play, pause, etc.).\n- width: Specifies the width of the video.\n- Like audio, use multiple <source> tags for different video formats.'),
(18, 1, 5, '1. Unordered Lists (ul)', 'Used to create a list of items without a specific order.\nEach item in the list is preceded by a bullet point.\n\nSyntax example:\n<ul>\n    <li>Item 1</li>\n    <li>Item 2</li>\n    <li>Item 3</li>\n</ul>'),
(19, 1, 5, '2. Ordered Lists (ol)', 'Used to create a list of items with a specific order.\nEach item is numbered automatically.\n\nSyntax example:\n<ol>\n    <li>First Item</li>\n    <li>Second Item</li>\n    <li>Third Item</li>\n</ol>'),
(20, 1, 5, '3. List Items (li)', 'Represents each item in both ordered and unordered lists.\nEnclosed in the <li> tag.\nCan be nested within both <ul> and <ol> tags.'),
(21, 1, 5, '4. Creating Simple Tables', 'HTML tables are used to organize and display data in rows and columns. The <table> tag defines the overall table structure, while <tr> (table row) is used to create individual rows within the table. Inside each row, the <td> (table data) tag defines individual cells that hold the data. For example, a simple table with two rows and two columns would use a combination of these tags to structure the content accordingly.'),
(22, 1, 6, '1. Introduction to Forms', 'A form (<form>) is used to collect user input in web applications. It acts as a container for different input elements like text fields, checkboxes, radio buttons, etc. Forms send user data to a server for processing using methods like GET or POST.'),
(23, 1, 6, '2. Input Types', 'The <input> tag in HTML is used to create various types of user input fields. <input type="text"> allows users to enter single-line text, while <input type="password"> functions similarly but masks the characters, making it suitable for password entries. <input type="submit"> creates a button that submits the form data to the server for processing. For selecting options, <input type="radio"> lets users choose one option from a group, and <input type="checkbox"> allows for selecting one or more options from a list.'),
(24, 1, 6, '3. Labels and Fieldsets', 'The <label> tag is used in HTML to provide a user-friendly and accessible name for input elements. It improves usability, especially when associated with an input using the for attribute that matches the input’s id. For example, <label for="username">Username:</label> pairs with <input type="text" id="username">. The <fieldset> tag is used to group related form elements together, offering better structure and readability, especially in longer forms. It is commonly used with a <legend> element that provides a caption for the grouped content, such as in: <fieldset><legend>Account Information</legend><label for="email">Email:</label><input type="text" id="email"></fieldset>.'),
(25, 1, 6, '4. Basic Form Validation', 'Form validation ensures that users provide correct and complete input before submitting the form. HTML5 provides built-in validation for required fields (required), email format (type="email"), and input length (minlength, maxlength).\nJavaScript can be used for more complex custom validation.\n\nExample:\n<input type="email" required>\n<input type="text" minlength="5" maxlength="20">'),
(26, 1, 7, '1. The Evolution of HTML: Introduction to HTML5', '- HTML (HyperText Markup Language) has evolved over the years, with HTML5 being the latest version.\n- HTML5 introduced new features aimed at improving the structure and functionality of web pages.\n- It focuses on making web content more semantic, accessible, and compatible across various devices.'),
(27, 1, 7, '2. Understanding Semantic Elements', 'Semantic elements in HTML5 are designed to give meaning to web page content. They help both developers and browsers understand the structure of a page. Some key elements include:\n\n- <header>: Defines the header section of a webpage, typically containing introductory content or navigational links.\n- <footer>: Represents the footer section, containing information like copyright, links, and other metadata.\n- <article>: Used to define independent, self-contained content, such as blog posts or news articles.\n- <section>: Represents a thematic grouping of content, such as a chapter of a book or different sections of a webpage.\n- <aside>: Defines content that''s related to the main content, like sidebars or extra information.\n- <nav>: Used for navigational purposes, housing menus or links that help users navigate the website.'),
(28, 1, 7, '3. Importance of Semantic Elements for Accessibility and SEO', '- Accessibility: Semantic elements make web content easier to navigate for users relying on assistive technologies, such as screen readers. These technologies can easily interpret the meaning of each section.\n- SEO (Search Engine Optimization): Search engines prefer well-structured, semantic HTML. It helps them better index the content, improving a webpage''s visibility in search results.'),
(29, 1, 8, 'Objective', 'Combine learned skills to create a basic, functional webpage.'),
(30, 1, 8, '1. Structuring Your Webpage', '- HTML Basics: Use HTML to structure your webpage.\n  - <!DOCTYPE html> - Defines the document type.\n  - <html> - Root element.\n  - <head> - Contains meta-information and links to stylesheets.\n  - <body> - Contains the content of the webpage.'),
(31, 1, 8, '2. Adding Content', '- Text Content: Use HTML tags to add headings, paragraphs, lists, etc.\n  - <h1> to <h6> - Headings.\n  - <p> - Paragraphs.\n  - <ul>, <ol>, <li> - Lists.\n- Images: Add images with the <img> tag.\n  - <img src="image.jpg" alt="Description">\n- Links: Create hyperlinks using the <a> tag.\n  - <a href="https://example.com">Link Text</a>'),
(32, 1, 8, '3. Linking Pages', '- Internal Links: Link to other pages within your site.\n  - <a href="page2.html">Go to Page 2</a>\n- External Links: Link to other websites.\n  - <a href="https://example.com" target="_blank">External Site</a>'),
(33, 1, 8, '4. Basic Styling', '- Inline Styles: Apply styles directly within HTML tags.\n  - <p style="color:blue;">Styled Text</p>\n- Internal CSS: Use the <style> tag within the <head> section.\n  <style>\n    body {\n      font-family: Arial, sans-serif;\n    }\n    h1 {\n      color: #333;\n    }\n  </style>\n- External CSS: Link to an external stylesheet using <link>.\n  - <link rel="stylesheet" href="styles.css">'),
(34, 1, 8, '5. Example', '<!DOCTYPE html>\n<html>\n<head>\n<title>My Webpage</title>\n<style>\n  body {\n    font-family: Arial, sans-serif;\n  }\n  h1 {\n    color: #333;\n  }\n</style>\n</head>\n<body>\n<h1>Welcome to My Webpage</h1>\n<p>This is a simple webpage created for practice.</p>\n<a href="page2.html">Go to Page 2</a>\n<img src="image.jpg" alt="Example Image">\n</body>\n</html>'),
(35, 1, 9, '1. Personal Portfolio', 'Create a webpage to showcase your skills, projects, and resume.'),
(36, 1, 9, '2. Recipe Page', 'Design a webpage with your favorite recipes, including ingredients and steps.'),
(37, 1, 9, '3. Travel Blog', 'Build a page about your favorite travel destinations with images and descriptions.'),
(38, 1, 9, '4. Event Invitation', 'Develop a page to invite people to an event, including details like time, location, and RSVP options.'),
(39, 1, 9, '5. Simple Quiz', 'Create a quiz with multiple-choice questions and display the results on the same page.'),
(40, 1, 9, '6. To-Do List', 'Build a basic to-do list where users can add, check off, and remove tasks.'),
(41, 1, 9, '7. Landing Page', 'Design a landing page for a fictional product or service, highlighting its features and benefits.'),
(42, 2, 10, '1. What is CSS and Why it is Used', 'CSS (Cascading Style Sheets) is a language used to style and layout web pages. It controls the visual appearance of HTML elements. <ul><li>Separate content (HTML) from presentation (CSS)</li><li>Improve flexibility in styling and page layout</li><li>Better maintenance and scalability of web projects</li></ul>'),
(43, 2, 10, '2. CSS Syntax and Structure', 'CSS is made up of rules that consist of selectors and declarations. <br><strong>Basic Structure:</strong> <code>selector &#123;<br>&nbsp;&nbsp;property: value;<br>&#125;</code> <br><strong>Example:</strong> <code>p &#123;<br>&nbsp;&nbsp;color: blue;<br>&nbsp;&nbsp;font-size: 16px;<br>&#125;</code>'),
(44, 2, 10, '3. CSS Selectors', 'CSS selectors target HTML elements for styling. <h3>Element Selector</h3><code>h1 &#123;<br>&nbsp;&nbsp;color: green;<br>&#125;</code><h3>Class Selector</h3><code>.button &#123;<br>&nbsp;&nbsp;background-color: red;<br>&nbsp;&nbsp;color: white;<br>&#125;</code><h3>ID Selector</h3><code>#main-header &#123;<br>&nbsp;&nbsp;font-size: 24px;<br>&nbsp;&nbsp;font-weight: bold;<br>&#125;</code>'),
(45, 2, 10, '4. Applying CSS: Inline, Internal, and External Stylesheets', '<h3>Inline CSS</h3><code>&lt;p style="color: blue;"&gt;This is a blue paragraph.&lt;/p&gt;</code><h3>Internal CSS</h3><code>&lt;style&gt;<br>&nbsp;&nbsp;body &#123;<br>&nbsp;&nbsp;&nbsp;&nbsp;background-color: lightgray;<br>&nbsp;&nbsp;&#125;<br>&lt;/style&gt;</code><h3>External CSS</h3><p>External CSS is written in a separate file with a <code>.css</code> extension and linked to the HTML document using the <code>&lt;link&gt;</code> tag.</p><code>&lt;link rel="stylesheet" href="styles.css"&gt;</code><p>Example of <code>styles.css</code> file:</p><code>h2 &#123;<br>&nbsp;&nbsp;color: navy;<br>&#125;</code>'),
(46, 2, 11, '1. Understanding the CSS Box Model', 'The CSS Box Model is a fundamental concept in CSS that describes the rectangular boxes generated for elements in the document. Every HTML element is considered as a box, which consists of the following parts (from the innermost to the outermost): <ul><li><strong>Content</strong>: The actual content of the box (text, image, etc.).</li><li><strong>Padding</strong>: Space between the content and the border.</li><li><strong>Border</strong>: A line that surrounds the padding and content.</li><li><strong>Margin</strong>: The space outside the border between this element and other elements.</li></ul>'),
(47, 2, 11, '2. Margin, Padding, Border, and Content', '<h3>Content</h3><p>This is where your actual content (text, images) appears. You can set the size of the content using the <code>width</code> and <code>height</code> properties.</p><div class="content-box">Content goes here</div><h3>Padding</h3><p>The padding adds space around the content inside the box. It creates a buffer between the content and the border.</p><div class="padding-box">Content with padding</div><h3>Border</h3><p>The border is the line that surrounds the padding and content. You can control the style, color, and thickness of the border.</p><div class="border-box">Content with border</div><h3>Margin</h3><p>Margin is the space between the element''s border and neighboring elements.</p><div class="margin-box">Content with margin</div>'),
(48, 2, 11, '3. Width and Height Properties', '<h3>Width</h3><p>Sets the width of the content box (excluding padding, border, and margin).</p><div class="width-box">Width example</div><h3>Height</h3><p>Sets the height of the content box.</p><div class="height-box">Height example</div>'),
(49, 2, 11, '4. Box-Sizing: Border-Box', '<p>By default, the <code>width</code> and <code>height</code> only apply to the content area, not including padding, border, or margin. To include padding and border in the width and height calculation, you can use the <code>box-sizing</code> property.</p><pre><code>box-sizing: border-box;</code></pre><p>This ensures that the total width of the element (content + padding + border) remains 200px.</p><div class="box-sizing-example">Box with border-box</div>'),
(50, 2, 12, '1. Colors, Backgrounds, and Borders', 'CSS allows you to set colors for text, backgrounds, and borders using color names, HEX codes, and RGB values.'),
(51, 2, 12, '2. Setting Colors', 'CSS allows you to set colors for text, backgrounds, and borders using color names, HEX codes, and RGB values.'),
(52, 2, 12, '3. Setting Text Color', 'You can change the text color using the color property: p { color: red; color: #ff0000; color: rgb(255, 0, 0); }'),
(53, 2, 12, '4. Setting Background Color', 'Use the background-color property to set the background of an element: div { background-color: lightblue; background-color: #00ff00; background-color: rgb(0, 255, 0); }'),
(54, 2, 12, '5. Setting Border Color', 'The border-color property sets the color of the border: .box { border: 2px solid black; border-color: #000000; border-color: rgb(0, 0, 0); }'),
(55, 2, 12, '6. Using Color Names, HEX Codes, and RGB Values', 'CSS supports three main ways to define colors: Color Names: Red, Blue, Green, etc. HEX Codes: #RRGGBB format (e.g., #ff0000 is red) RGB Values: rgb(red, green, blue) with values from 0 to 255.'),
(56, 2, 12, '7. Adding Background Images', 'You can add a background image using the background-image property: body { background-image: url("background.jpg"); }'),
(57, 2, 12, '8. Controlling Background Properties', 'These properties control how the image behaves: background-repeat: Controls how the image repeats (default is repeat). background-size: Specifies the size of the background image. background-position: Sets the position of the background image.'),
(58, 2, 12, '9. Styling Borders', 'Borders are styled using several properties: border-style: Defines the style (solid, dotted, dashed, etc.). border-width: Sets the width of the border. border-color: Sets the color of the border.'),
(59, 2, 12, '10. Shorthand for Borders', 'You can use the shorthand border to define all border properties in one line: .box { border: 2px solid red; }'),
(60, 2, 12, '11. Example Usage', 'Here is a full example of a basic HTML page that demonstrates the use of colors, backgrounds, and borders. The <!DOCTYPE html> declaration defines the document type as HTML5. The <html> element wraps the entire content, with the <head> containing metadata and styling. Inside the <style> tag, a paragraph (<p>) is styled with green text (color: rgb(0, 128, 0);), a <div> is given a light grey background (background-color: #f0f0f0) with a red dashed border (border: 3px dashed red;), and the <body> is styled with a background image (background-image: url("example.jpg");) that is set to cover the entire area and stay centered. In the <body>, a <div> encloses a <p> element that displays the styled content.'),
(61, 2, 13, '1. Typography and Text Styling', 'Font family refers to the typeface used to display text on a webpage. Common font families include Serif, Sans-serif, and Monospace.'),
(62, 2, 13, '2. Font Families', 'Font family refers to the typeface used to display text on a webpage. Common font families include Serif, Sans-serif, and Monospace.'),
(63, 2, 13, '3. Common font families', 'Serif: Times New Roman, Georgia; Sans-serif: Arial, Helvetica; Monospace: Courier, Consolas.'),
(64, 2, 13, '4. Font Sizes', 'Font size controls how large or small the text appears. Sizes can be set in pixels (px), ems (em), rems (rem), and percentages (%).'),
(65, 2, 13, '5. Font Weights', 'Font weight determines the thickness or boldness of the text. Values can be keywords like normal, bold, or numerical values (e.g., 100, 300, 400, 700).'),
(66, 2, 13, '6. Text Alignment', 'Text alignment specifies how text is aligned within its container. Common values are left, right, center, and justify.'),
(67, 2, 13, '7. Text Spacing', 'Spacing between text lines, letters, or words can be controlled using line-height, letter-spacing, and word-spacing properties.'),
(68, 2, 13, '8. Text Decoration', 'Text decoration is used to add styles like underlining, overlining, or striking through text. Values can be none, underline, line-through, or overline.'),
(69, 2, 13, '9. Using Web Fonts (Google Fonts)', 'Web fonts allow you to use custom fonts from external sources like Google Fonts. To use them, embed the font link in your HTML or import it in your CSS.'),
(70, 2, 13, '10 .Styling Lists (Ordered and Unordered)', 'Customize the appearance of ordered (numbered) and unordered (bulleted) lists using list-style-type and list-style-position properties.'),
(71, 2, 14, '1. CSS Positioning', 'Positioning in CSS defines how elements are positioned on a page. The primary types are Static, Relative, Absolute, and Fixed.'),
(72, 2, 14, '2. Static Positioning', 'Static positioning is the default positioning for all elements. Elements with static positioning are positioned according to the normal flow of the document.'),
(73, 2, 14, '3. Relative Positioning', 'Relative positioning allows an element to be positioned relative to its normal position. It does not affect the layout of other elements.'),
(74, 2, 14, '4. Absolute Positioning', 'Absolute positioning places an element relative to the nearest positioned ancestor, or the viewport if no ancestor is positioned.'),
(75, 2, 14, '5. Fixed Positioning', 'Fixed positioning keeps the element in place relative to the viewport, even when the page is scrolled.'),
(76, 2, 14, '6. Float and Clear', 'Float is used to position elements to the left or right, allowing text or inline elements to wrap around them. Clear is used to prevent elements from flowing around floats.'),
(77, 2, 14, '7. Float', 'Float allows elements to be taken out of the normal document flow and placed either on the left or right side of their container.'),
(78, 2, 14, '7. Clear', 'Clear is used to control the behavior of elements following floated elements. It can be used to clear the float, causing the element to move below the float.'),
(79, 2, 14, '8. Flexbox Basics', 'Flexbox is a layout model that allows items within a container to be aligned and distributed easily. It uses properties like display, justify-content, and align-items to control the layout.'),
(80, 2, 14, '9. Display Flex', 'The display: flex property defines a flex container and enables flexbox layout for its children elements.'),
(81, 2, 14, '10. Justify-Content', 'justify-content controls the alignment of flex items along the main axis (horizontal by default). It can be used to center, space out, or align items in other ways.'),
(82, 2, 14, '11. Align-Items', 'align-items controls the alignment of flex items along the cross axis (vertical by default).'),
(83, 2, 14, '12. CSS Grid Introduction', 'CSS Grid is a layout system for creating two-dimensional layouts. It allows for precise control over rows and columns.'),
(84, 2, 14, '13. Basic Grid Layout', 'A basic grid layout can be created using the display: grid property, and grid-template-columns defines the number of columns in the layout.'),
(85, 2, 15, '1. Introduction to Responsive Design', '<p><strong>Definition</strong>: Responsive design ensures a website looks good and functions well on all devices (desktops, tablets, smartphones).</p>\r\n<p><strong>Key Concept</strong>: Fluid grids, flexible images, and media queries.</p>'),
(86, 2, 15, '2. Using Media Queries', '<p><strong>Purpose</strong>: Apply different styles based on device characteristics (e.g., screen size, orientation).</p>\r\n<p><strong>Syntax</strong>:</p>\r\n<code>\r\n@media (condition) {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;/* CSS rules here */<br>\r\n}\r\n</code>\r\n<p><strong>Example</strong>:</p>\r\n<code>\r\n/* Styles for devices with a max width of 600px */<br>\r\n@media (max-width: 600px) {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;body {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;background-color: lightblue;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;.container {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: 10px;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n}<br>\r\n<br>\r\n/* Styles for devices with a min width of 601px */<br>\r\n@media (min-width: 601px) {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;body {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;background-color: white;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;.container {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: 20px;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n}\r\n</code>'),
(87, 2, 15, '3. Mobile-First Design Approach', '<p><strong>Definition</strong>: Design for mobile devices first, then scale up to larger screens.</p>\r\n<p><strong>Benefits</strong>: Better performance on mobile devices, simplified content.</p>\r\n<p><strong>Implementation</strong>:</p>\r\n<ul>\r\n    <li><strong>Base Styles</strong>: Apply default styles for mobile devices.</li>\r\n    <li><strong>Media Queries for Larger Screens</strong>: Use <code>min-width</code> to add styles for tablets and desktops.</li>\r\n</ul>\r\n<p><strong>Example</strong>:</p>\r\n<code>\r\n/* Base styles for mobile devices */<br>\r\nbody {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;font-size: 14px;<br>\r\n}<br>\r\n<br>\r\n/* Styles for tablets and larger screens */<br>\r\n@media (min-width: 768px) {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;body {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;font-size: 16px;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n}<br>\r\n<br>\r\n/* Styles for desktops */<br>\r\n@media (min-width: 1024px) {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;body {<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;font-size: 18px;<br>\r\n&nbsp;&nbsp;&nbsp;&nbsp;}<br>\r\n}\r\n</code>'),
(88, 2, 16, 'Responsive Portfolio Websites', 'Create a personal portfolio that adjusts layout and styling for different screen sizes using media queries and flexible layouts. Include sections like About, Projects, and Contact.'),
(89, 2, 16, 'CSS Art', 'Design creative illustrations or artwork using only HTML and CSS. Experiment with shapes, gradients, shadows, and animations to form visuals.'),
(90, 2, 16, 'Landing Page', 'Build a visually appealing landing page for a product or service with clear calls-to-action, smooth scrolling, and responsive elements.'),
(91, 2, 16, 'Interactive Navigation Menu', 'Develop a navigation bar with interactive hover effects, dropdowns, and transitions using only CSS. Ensure accessibility and responsiveness.'),
(92, 2, 16, 'CSS Grid Layout', 'Use CSS Grid to create a complex webpage layout like a magazine or product catalog. Practice grid-template-areas and responsive adjustments.'),
(93, 2, 16, 'Theme Blog Layout', 'Design a themed blog post layout with styled headings, sidebars, comment sections, and tags. Incorporate CSS variables for easy theme changes.'),
(94, 2, 16, 'Animated Login Form', 'Create a stylish login form with animations and transitions for input fields, focus states, and submit button. Ensure mobile compatibility.'),
(95, 2, 16, 'Custom Forms', 'Design custom-styled form controls like checkboxes, radio buttons, and select menus using CSS. Maintain usability and form accessibility.'),
(96, 2, 16, 'CSS Parallax Scrolling', 'Implement a parallax scrolling effect using background images and layered elements. Enhance visual storytelling on a webpage.'),
(97, 2, 16, 'Responsive Grid System', 'Build a responsive CSS-only grid system that adapts to various screen sizes. Use it to structure content in columns and rows effectively.'),
(98, 3, 18, 'Overview of Python and Its Applications', 'Python is a high-level, interpreted programming language known for its readability and simplicity. It was created by Guido van Rossum and first released in 1991. Python supports multiple programming paradigms, including procedural, object-oriented, and functional programming.\r\n\r\nApplications:\r\n- Web Development: Python is widely used in web development with frameworks like Django and Flask that allow for the creation of robust web applications.\r\n- Data Analysis: Python''s libraries such as Pandas and NumPy are crucial for data manipulation and analysis. These tools provide powerful data structures and functions for handling large datasets.\r\n- Machine Learning: Python has extensive support for machine learning and artificial intelligence through libraries like TensorFlow, Keras, and scikit-learn.\r\n- Automation: Python is often used for scripting and automating repetitive tasks, thanks to its easy-to-read syntax and extensive standard library.'),
(99, 3, 18, 'Installing Python and Setting Up the Development Environment', 'To start programming in Python, you need to install it on your system. Follow these steps:\r\n1. Go to the official Python website: python.org\r\n2. Download the latest version of Python.\r\n3. Run the installer. On the installation screen, ensure you check the box that says Add Python to PATH before clicking Install Now.\r\n4. After installation, you can check if Python is installed correctly by opening a command prompt or terminal and typing python --version. You should see the Python version number.\r\n\r\nFor development, you can choose an Integrated Development Environment (IDE) or a text editor. Popular choices include:\r\n- PyCharm: A feature-rich IDE specifically for Python development.\r\n- Visual Studio Code: A lightweight but powerful code editor with Python support through extensions.\r\n- Jupyter Notebook: An interactive environment ideal for data analysis and visualization.'),
(100, 3, 18, 'Hello World Example', 'Here is a simple example of a Python program that prints "Hello, World!" to the console:\r\n\r\nprint("Hello, World!")\r\n\r\nThis program uses the print() function, which outputs text to the console.'),
(101, 3, 19, 'Python Syntax and Basic Structure', 'Python is known for its clean and readable syntax. The basic structure includes:\r\n• Indentation: Used to define blocks of code (spaces or tabs)\r\n• Comments: Preceded by # symbol, not executed\r\n\r\nExample:\r\n# This is a comment\r\ndef my_function():\r\n    print("Indented block")'),
(102, 3, 19, 'Variables and Data Types', 'Variables store data values. Python data types include:\r\n• String: Text data in quotes\r\n• Integer: Whole numbers\r\n• Float: Decimal numbers\r\n• Boolean: True or False\r\n\r\nExamples:\r\nname = "Alice"  # String\r\nage = 30        # Integer\r\nheight = 5.5    # Float\r\nis_student = True  # Boolean'),
(103, 3, 19, 'Basic Operations and Expressions', 'Python arithmetic operations:\r\n• Addition (+)\r\n• Subtraction (-)\r\n• Multiplication (*)\r\n• Division (/)\r\n• String concatenation (+)\r\n\r\nExamples:\r\nsum = 10 + 5\r\ndifference = 10 - 5\r\nproduct = 10 * 5\r\nquotient = 10 / 5\r\ngreeting = "Hello" + " " + "Alice"'),
(104, 3, 19, 'Input and Output Functions', 'Python I/O functions:\r\n• input(): Gets user input\r\n• print(): Displays output\r\n\r\nExample:\r\nname = input("Enter your name: ")\r\nprint("Hello, " + name)'),
(105, 3, 20, 'Conditional Statements', 'Conditional statements (if/elif/else) execute code blocks based on conditions.\r\n\r\nExample:\r\nage = 20\r\nif age >= 18:\r\n    print("Adult")\r\nelse:\r\n    print("Minor")'),
(106, 3, 20, 'For Loops', 'For loops iterate over sequences (lists, ranges, etc.)\r\n\r\nExample:\r\nfor i in range(5):\r\n    print(i)'),
(107, 3, 20, 'While Loops', 'While loops execute as long as a condition is true.\r\n\r\nExample:\r\ncount = 0\r\nwhile count < 5:\r\n    print(count)\r\n    count += 1'),
(108, 3, 20, 'List Comprehensions', 'List comprehensions provide a concise way to create lists.\r\n\r\nExample:\r\nsquares = [x**2 for x in range(5)]\r\nprint(squares)  # Output: [0, 1, 4, 9, 16]'),
(109, 3, 21, 'Defining and Using Functions', 'Functions are defined with def keyword and help organize reusable code.\r\n\r\nExample:\r\ndef greet(name):\r\n    """Print a greeting message."""\r\n    print(f"Hello, {name}!")\r\n\r\ngreet("Alice")  # Calls the function'),
(110, 3, 21, 'Function Parameters and Return Values', 'Functions can take parameters and return values using return.\r\n\r\nExample:\r\ndef add(a, b):\r\n    """Return the sum of two numbers."""\r\n    return a + b\r\n\r\nresult = add(5, 3)  # Returns 8'),
(111, 3, 21, 'Modules and Importing', 'Modules are Python files containing reusable code that can be imported.\r\n\r\nExample:\r\nimport math\r\nresult = math.sqrt(16)  # Uses math module function'),
(112, 3, 21, 'Creating and Using Custom Modules', 'Custom modules are created by saving code in .py files.\r\n\r\nExample (mymodule.py):\r\ndef say_hello():\r\n    print("Hello from mymodule!")\r\n\r\nUsage:\r\nimport mymodule\r\nmymodule.say_hello()'),
(113, 3, 22, 'Lists', 'Lists are ordered, mutable collections that can contain different data types.\r\n\r\nExample:\r\nfruits = ["apple", "banana", "cherry"]\r\nprint(fruits[1])  # Output: banana\r\nfruits.append("date")\r\nfruits.remove("banana")\r\nfor fruit in fruits:\r\n    print(fruit)'),
(114, 3, 22, 'Tuples', 'Tuples are ordered, immutable collections.\r\n\r\nExample:\r\ncoordinates = (10.0, 20.0)\r\nprint(coordinates[0])  # Output: 10.0\r\n# coordinates[0] = 15.0  # Would raise error'),
(115, 3, 22, 'Sets', 'Sets are unordered collections of unique items.\r\n\r\nExample:\r\nunique_numbers = {1, 2, 3, 4}\r\nunique_numbers.add(5)\r\nunique_numbers.discard(3)\r\nprint(2 in unique_numbers)  # Output: True\r\nfor number in unique_numbers:\r\n    print(number)'),
(116, 3, 22, 'Dictionaries', 'Dictionaries store key-value pairs for fast lookup.\r\n\r\nExample:\r\nperson = {"name": "Alice", "age": 30}\r\nprint(person["name"])  # Output: Alice\r\nperson["occupation"] = "Engineer"\r\ndel person["age"]\r\nfor key, value in person.items():\r\n    print(f"{key}: {value}")'),
(117, 3, 23, 'Reading from Files', 'Python provides multiple methods to read file contents:\r\n• read(): Reads entire file\r\n• readline(): Reads one line\r\n• readlines(): Returns list of lines\r\n\r\nExample:\r\nwith open("example.txt", "r") as file:\r\n    content = file.read()\r\n    file.seek(0)\r\n    first_line = file.readline()\r\n    file.seek(0)\r\n    lines = file.readlines()\r\n    for line in lines:\r\n        print(line.strip())'),
(118, 3, 23, 'Writing to Files', 'Files can be written using write() and writelines():\r\n• "w" mode: Overwrites file\r\n• "a" mode: Appends to file\r\n\r\nExample:\r\nwith open("example.txt", "w") as file:\r\n    file.write("Hello, World!\n")\r\n    lines = ["Line 1\n", "Line 2\n", "Line 3\n"]\r\n    file.writelines(lines)'),
(119, 3, 23, 'Handling File Exceptions', 'File operations should use try-except blocks to handle errors:\r\n• FileNotFoundError: Missing file\r\n• IOError: General I/O issues\r\n\r\nExample:\r\ntry:\r\n    with open("nonexistent.txt", "r") as file:\r\n        content = file.read()\r\nexcept FileNotFoundError:\r\n    print("File not found")\r\nexcept IOError:\r\n    print("I/O error occurred")'),
(120, 3, 24, 'Introduction to Exceptions', 'Exceptions disrupt normal program flow and can be raised explicitly.\r\n\r\nExample:\r\nraise ValueError("Custom error message")  # Raises an exception'),
(121, 3, 24, 'Using Try and Except', 'try/except blocks handle exceptions gracefully.\r\n\r\nExample:\r\ntry:\r\n    result = 10 / 0  # Division by zero\r\nexcept ZeroDivisionError:\r\n    print("Cannot divide by zero!")'),
(122, 3, 24, 'Finally and Else Clauses', 'finally always executes; else runs when no exceptions occur.\r\n\r\nExample:\r\ntry:\r\n    file = open("example.txt", "r")\r\nexcept FileNotFoundError:\r\n    print("File not found")\r\nelse:\r\n    print("Read successfully")\r\nfinally:\r\n    file.close()\r\n    print("File closed")'),
(123, 3, 24, 'Custom Exceptions', 'Create custom exceptions by inheriting from Exception class.\r\n\r\nExample:\r\nclass CustomError(Exception):\r\n    pass\r\n\r\ntry:\r\n    raise CustomError("Custom message")\r\nexcept CustomError as e:\r\n    print(e)'),
(124, 3, 25, 'Classes and Objects', 'Classes are blueprints for creating objects with attributes and methods.\r\n\r\nExample:\r\nclass Person:\r\n    def __init__(self, name, age):\r\n        self.name = name\r\n        self.age = age\r\n    \r\n    def greet(self):\r\n        print(f"Hello, I''m {self.name}, age {self.age}")\r\n\r\nperson1 = Person("Alice", 30)\r\nperson1.greet()'),
(125, 3, 25, 'Inheritance', 'Child classes inherit attributes and methods from parent classes.\r\n\r\nExample:\r\nclass Animal:\r\n    def __init__(self, name):\r\n        self.name = name\r\n    \r\n    def speak(self):\r\n        raise NotImplementedError\r\n\r\nclass Dog(Animal):\r\n    def speak(self):\r\n        print(f"{self.name} says woof!")\r\n\r\ndog1 = Dog("Buddy")\r\ndog1.speak()'),
(126, 3, 25, 'Encapsulation', 'Private attributes (__prefix) restrict direct access to object data.\r\n\r\nExample:\r\nclass BankAccount:\r\n    def __init__(self, owner, balance):\r\n        self.owner = owner\r\n        self.__balance = balance\r\n    \r\n    def deposit(self, amount):\r\n        if amount > 0:\r\n            self.__balance += amount\r\n    \r\n    def get_balance(self):\r\n        return self.__balance\r\n\r\naccount = BankAccount("Alice", 1000)\r\naccount.deposit(500)\r\nprint(account.get_balance())'),
(127, 3, 25, 'Polymorphism', 'Methods behave differently based on the object type.\r\n\r\nExample:\r\nclass Shape:\r\n    def area(self):\r\n        raise NotImplementedError\r\n\r\nclass Rectangle(Shape):\r\n    def area(self):\r\n        return self.width * self.height\r\n\r\nclass Circle(Shape):\r\n    def area(self):\r\n        return 3.14 * self.radius ** 2\r\n\r\nshapes = [Rectangle(10,5), Circle(7)]\r\nfor shape in shapes:\r\n    print(shape.area())'),
(128, 3, 26, 'Project Planning Tips', '1. Define clear project requirements\r\n2. Break down into smaller tasks\r\n3. Create a development timeline\r\n4. Choose appropriate data structures\r\n5. Plan for error handling\r\n6. Document your code as you go'),
(129, 3, 26, 'Project Structure Best Practices', 'Good project structure:\r\nproject/\r\n??? main.py          # Entry point\r\n??? utils/           # Helper functions\r\n?   ??? file_io.py\r\n?   ??? calculations.py\r\n??? models/          # Data models/classes\r\n?   ??? user.py\r\n??? tests/           # Test files\r\n?   ??? test_core.py\r\n??? requirements.txt # Dependencies\r\n\r\nKeep related files together and separate concerns.'),
(130, 3, 26, 'Common Python Libraries', 'Essential libraries for projects:\r\n• pandas - Data analysis\r\n• numpy - Numerical operations\r\n• requests - HTTP requests\r\n• flask/django - Web frameworks\r\n• pytest - Testing\r\n• matplotlib - Data visualization\r\n• sqlite3 - Built-in database'),
(131, 3, 26, 'Data Structures Review', 'Lists: Mutable ordered sequences\r\nTuples: Immutable ordered sequences\r\nSets: Unordered unique elements\r\nDictionaries: Key-value pairs\r\nCollections: Specialized container types\r\n\r\nRemember time complexity for operations!'),
(132, 3, 26, 'Function Best Practices', '• Keep functions small/single-purpose\r\n• Use descriptive names\r\n• Limit parameters (3-4 max)\r\n• Return consistent data types\r\n• Use docstrings\r\n• Avoid global variables\r\n• Handle expected exceptions'),
(133, 3, 26, 'OOP Principles Summary', 'Encapsulation: Hide implementation details\r\nInheritance: Create hierarchical relationships\r\nPolymorphism: Same interface, different behaviors\r\nAbstraction: Simplify complex reality\r\n\r\nRemember composition over inheritance!'),
(134, 3, 26, 'Debugging Techniques', '1. Use print() statements strategically\r\n2. Leverage logging module\r\n3. Learn to use debugger (pdb)\r\n4. Check stack traces carefully\r\n5. Validate assumptions\r\n6. Rubber duck debugging\r\n7. Isolate the problem'),
(135, 3, 26, 'Testing Strategies', 'Unit Testing:\r\n• Test individual components\r\n• Use pytest/unittest\r\n• Mock external dependencies\r\n\r\nIntegration Testing:\r\n• Test component interactions\r\n• Verify data flow\r\n\r\nTest Cases Should Cover:\r\n• Normal operation\r\n• Edge cases\r\n• Invalid inputs'),
(136, 3, 26, 'Performance Optimization', '1. Profile before optimizing (cProfile)\r\n2. Focus on bottlenecks\r\n3. Use built-in functions\r\n4. Consider generators for large data\r\n5. Memoize expensive calculations\r\n6. Avoid premature optimization'),
(137, 3, 26, 'Documentation Guidelines', 'Include:\r\n1. Project description/purpose\r\n2. Installation instructions\r\n3. Usage examples\r\n4. API documentation (if applicable)\r\n5. Known issues\r\n6. Future improvements\r\n\r\nUse docstrings and generate docs with Sphinx/pdoc if possible.'),
(138, 3, 26, 'Submission Checklist', '? All requirements implemented\r\n? Code properly formatted (PEP 8)\r\n? Adequate test coverage\r\n? Documentation complete\r\n? No sensitive data in code\r\n? Requirements file included\r\n? Demo ready (if required)'),
(139, 3, 26, 'Presentation Tips', '1. Explain your thought process\r\n2. Highlight key features\r\n3. Demonstrate functionality\r\n4. Discuss challenges overcome\r\n5. Share lessons learned\r\n6. Prepare for Q&A\r\n7. Keep within time limits'),
(140, 4, 27, 'What is Java?', 'Java is a high-level, object-oriented programming language developed by Sun Microsystems (now owned by Oracle). It is designed to be platform-independent, meaning Java code can run on any device that has a Java Virtual Machine (JVM). Java is widely used for developing applications across a variety of platforms, including web, mobile, and desktop.'),
(141, 4, 27, 'Why Java?', '<ul><li><strong>Platform Independence:</strong> "Write Once, Run Anywhere" – Java code can run on any machine that supports the JVM.</li><li><strong>Object-Oriented:</strong> It follows object-oriented principles, allowing for reusable and scalable code.</li><li><strong>Robust and Secure:</strong> Java includes features like garbage collection and exception handling to make it robust, and it provides built-in security features.</li></ul>'),
(142, 4, 27, 'Java Development Kit (JDK)', 'The JDK contains the tools required to write and run Java applications, including the compiler (<code>javac</code>), the interpreter (<code>java</code>), and other utilities.'),
(143, 4, 27, 'Integrated Development Environment (IDE)', '<ul><li>Eclipse and IntelliJ IDEA are popular IDEs that simplify Java development with features like auto-completion, debugging, and project management.</li></ul>'),
(144, 4, 27, 'Example: Hello World Program', '<pre><code>public class HelloWorld {\n    public static void main(String[] args) {\n        System.out.println("Hello, World!"); // Output: Hello, World!\n    }\n}</code></pre>'),
(145, 4, 28, 'Variables', 'Variables in Java are used to store data that can be used and manipulated throughout the program. Every variable must be declared with a data type, which defines the kind of data it holds (e.g., integer, floating-point number, character).'),
(146, 4, 28, 'Data Types', '<ul><li><strong>Primitive Types:</strong><ul><li><code>int:</code> Stores integers without decimal points (e.g., 5, -10). Example: <code>int age = 25;</code></li><li><code>double:</code> Stores floating-point numbers with decimals (e.g., 5.99). Example: <code>double pi = 3.14;</code></li><li><code>char:</code> Stores single characters (e.g., ''a'', ''B''). Example: <code>char grade = ''A'';</code></li><li><code>boolean:</code> Stores true or false values. Example: <code>boolean isJavaFun = true;</code></li></ul></li><li><strong>Reference Types:</strong> Includes classes, arrays, and interfaces. Example: <code>String name = "John";</code></li></ul>'),
(147, 4, 28, 'Operators', '<ul><li><strong>Arithmetic Operators:</strong> Used for performing mathematical operations. Examples: <code>+</code>, <code>-</code>, <code>*</code>, <code>/</code>, <code>%</code> (modulus).</li><li><strong>Relational Operators:</strong> Compare values and return a boolean. Examples: <code>==</code>, <code>!=</code>, <code>></code>, <code><</code>, <code>>=</code>, <code><=</code>.</li><li><strong>Logical Operators:</strong> Combine multiple conditions. Examples: <code>&&</code> (AND), <code>||</code> (OR), <code>!</code> (NOT).</li></ul>'),
(148, 4, 28, 'Example: Basic Arithmetic Operations', '<pre><code>public class VariablesExample {\n    public static void main(String[] args) {\n        int num1 = 10, num2 = 20;\n        int sum = num1 + num2;\n        System.out.println("Sum: " + sum); // Output: Sum: 30\n    }\n}</code></pre>'),
(149, 4, 29, 'If-Else Statements', 'Java''s conditional statements allow you to execute code based on whether a condition is true or false. The <code>if</code> statement is followed by a condition in parentheses, and if the condition is true, the code block inside the <code>if</code> statement is executed. If the condition is false, the code in the <code>else</code> block (if provided) is executed.'),
(150, 4, 29, 'Loops', 'Loops allow repetitive execution of a block of code until a specific condition is met.<ul><li><strong>For Loop:</strong> Typically used when the number of iterations is known.<pre><code>for (int i = 0; i &lt; 5; i++) {\n    System.out.println(i);\n}</code></pre></li><li><strong>While Loop:</strong> Used when the condition is evaluated before the loop is executed. The loop will continue as long as the condition is true.</li><li><strong>Do-While Loop:</strong> Similar to the while loop, but the condition is evaluated after the loop’s body is executed, ensuring the body runs at least once.</li></ul>'),
(151, 4, 29, 'Example: If-Else and For Loop', '<pre><code>public class ControlFlow {\n    public static void main(String[] args) {\n        int number = 10;\n        if (number &gt; 0) {\n            System.out.println("Number is positive.");\n        } else {\n            System.out.println("Number is negative.");\n        }\n\n        for (int i = 0; i &lt; 5; i++) {\n            System.out.println("Loop iteration: " + i);\n        }\n    }\n}</code></pre>'),
(152, 4, 30, 'Methods', 'Methods are blocks of code designed to perform a specific task. In Java, every method must be part of a class. A method is defined with a return type, method name, and parameters (if any).<ul><li><strong>Return Type:</strong> Specifies what type of data the method will return. If no data is returned, use <code>void</code>.</li><li><strong>Parameters:</strong> Variables passed to a method to provide input. Multiple parameters are separated by commas.</li><li><strong>Method Overloading:</strong> Java allows multiple methods with the same name but different parameter lists. This is called overloading, allowing a method to handle different types or numbers of parameters.</li><li><strong>Scope:</strong> The scope of a variable defines its visibility within the program. Local variables are only accessible within the method where they are declared, while instance variables are available to all methods within the class.</li></ul>'),
(153, 4, 30, 'Example: Method Definition and Call', '<pre><code>public class MethodsExample {\n    public static void main(String[] args) {\n        int result = add(5, 10);\n        System.out.println("Result: " + result);\n    }\n\n    public static int add(int a, int b) {\n        return a + b;\n    }\n}</code></pre>'),
(154, 4, 31, 'Arrays', 'An array is a collection of elements of the same data type, stored in contiguous memory locations. Once an array is created, its size cannot be changed. Arrays are zero-indexed, meaning the first element is at index 0.<br><strong>Syntax:</strong> <code>dataType[] arrayName = new dataType[size];</code>'),
(155, 4, 31, 'Strings', 'In Java, a String is not a primitive data type but a class. Strings are immutable, meaning once a String object is created, it cannot be changed. Common String methods include:<ul><li><code>.length():</code> Returns the length of the string.</li><li><code>.substring():</code> Returns a portion of the string.</li><li><code>.replace():</code> Replaces characters in a string.</li></ul>');
INSERT INTO `notes` (`note_id`, `course_id`, `outline_id`, `section_title`, `section_content`) VALUES
(156, 4, 31, 'Example: Array and String Manipulation', '<pre><code>public class ArrayAndString {\n    public static void main(String[] args) {\n        // Array Example\n        int[] numbers = {1, 2, 3, 4};\n        for (int num : numbers) {\n            System.out.println(num); // Output: 1 2 3 4\n        }\n\n        // String Example\n        String text = "Hello, Java!";\n        System.out.println(text.toUpperCase()); // Output: HELLO, JAVA!\n    }\n}</code></pre>'),
(157, 4, 32, 'Classes and Objects', 'A class is a blueprint for creating objects, which are instances of the class. A class defines properties (variables) and behaviors (methods) that its objects will have.'),
(158, 4, 32, 'Constructors', 'Constructors are special methods that are called when an object is created. They initialize the object’s state. Constructors have the same name as the class and no return type.'),
(159, 4, 32, 'Static vs Instance Variables', '<ul><li><strong>Static Variables:</strong> These belong to the class rather than instances (objects) of the class. They are shared by all objects.</li><li><strong>Instance Variables:</strong> These are unique to each object and represent the state of that object.</li></ul>'),
(160, 4, 32, 'Example: Class and Object Creation', '<pre><code>public class Car {\n    String model;\n    int year;\n\n    // Constructor\n    public Car(String model, int year) {\n        this.model = model;\n        this.year = year;\n    }\n\n    public void displayInfo() {\n        System.out.println("Model: " + model + ", Year: " + year);\n    }\n\n    public static void main(String[] args) {\n        Car car = new Car("Toyota", 2020);\n        car.displayInfo(); // Output: Model: Toyota, Year: 2020\n    }\n}</code></pre>'),
(161, 4, 33, 'Inheritance', 'Inheritance is a mechanism in Java where one class can inherit properties and methods from another. This promotes code reuse and hierarchical classification. The <code>extends</code> keyword is used to create a subclass from a superclass. For example, <code>class Dog extends Animal</code> makes <code>Dog</code> inherit the properties and methods of <code>Animal</code>.'),
(162, 4, 33, 'Polymorphism', 'Polymorphism allows objects of different classes to be treated as objects of a common superclass. It can be achieved in two ways:<ul><li><strong>Method Overloading:</strong> Multiple methods with the same name but different parameters.</li><li><strong>Method Overriding:</strong> A subclass can provide its own implementation of a method that is already defined in its superclass.</li></ul>Polymorphism promotes flexibility in the code, allowing a single interface to be used for different data types or methods.'),
(163, 4, 33, 'Encapsulation', 'Encapsulation is the practice of wrapping data (variables) and methods within a class and restricting access to them using access modifiers (<code>private</code>, <code>public</code>, <code>protected</code>).<ul><li><strong>Private:</strong> Only accessible within the class.</li><li><strong>Public:</strong> Accessible from anywhere.</li><li><strong>Protected:</strong> Accessible within the package and by subclasses.</li></ul>'),
(164, 4, 33, 'Getters and Setters', 'These methods are used to access and update private variables, enforcing data hiding and integrity.'),
(165, 4, 33, 'Example: Inheritance, Polymorphism, and Encapsulation', '<pre><code>// Base class\nclass Animal {\n    protected String name;\n\n    public Animal(String name) {\n        this.name = name;\n    }\n\n    public void makeSound() {\n        System.out.println("Animal makes a sound");\n    }\n}\n\n// Derived class\nclass Dog extends Animal {\n\n    public Dog(String name) {\n        super(name);\n    }\n\n    // Overriding the method from the parent class\n    @Override\n    public void makeSound() {\n        System.out.println(name + " barks");\n    }\n}\n\npublic class InheritanceExample {\n    public static void main(String[] args) {\n        Animal myAnimal = new Animal("Generic Animal");\n        Dog myDog = new Dog("Buddy");\n\n        myAnimal.makeSound(); // Output: Animal makes a sound\n        myDog.makeSound();    // Output: Buddy barks\n\n        // Polymorphism\n        Animal polyDog = new Dog("Max");\n        polyDog.makeSound();  // Output: Max barks (even though it''s of type Animal)\n}</code></pre>'),
(166, 4, 34, 'Exception Handling', 'Exceptions are errors that occur during the execution of a program. In Java, exceptions are handled using <code>try</code>, <code>catch</code>, and <code>finally</code> blocks.<ul><li><strong>Try Block:</strong> Code that may throw an exception is placed inside the <code>try</code> block.</li><li><strong>Catch Block:</strong> Handles the exception if one is thrown. Specific exception types can be caught (e.g., <code>IOException</code>, <code>ArithmeticException</code>).</li><li><strong>Finally Block:</strong> Contains code that is always executed, whether an exception occurs or not (e.g., closing a file or a resource).</li></ul><strong>Throwing Exceptions:</strong> You can throw exceptions manually using the <code>throw</code> keyword. Custom exceptions can also be created by extending the <code>Exception</code> class.'),
(167, 4, 34, 'File I/O', 'Java provides the <code>java.io</code> package for reading from and writing to files.<ul><li><strong>FileWriter:</strong> Used to write to a file. You can append data to the end of a file using <code>new FileWriter(file, true)</code>.</li><li><strong>FileReader:</strong> Used to read from a file. When handling files, <code>IOException</code> must be caught or declared to be thrown.</li></ul>'),
(168, 4, 34, 'Example: Exception Handling and File I/O', '<pre><code>import java.io.FileWriter;\nimport java.io.FileReader;\nimport java.io.IOException;\n\npublic class ExceptionAndFileIOExample {\n\n    public static void main(String[] args) {\n        // Writing to a file\n        try {\n            FileWriter writer = new FileWriter("example.txt");\n            writer.write("Hello, File IO!");\n            writer.close();\n            System.out.println("Successfully wrote to the file.");\n        } catch (IOException e) {\n            System.out.println("An error occurred while writing to the file.");\n            e.printStackTrace();\n        }\n\n        // Reading from a file\n        try {\n            FileReader reader = new FileReader("example.txt");\n            int character;\n            while ((character = reader.read()) != -1) {\n                System.out.print((char) character);\n            }\n            reader.close();\n        } catch (IOException e) {\n            System.out.println("An error occurred while reading from the file.");\n            e.printStackTrace();\n        }\n\n        // Example of exception handling with try-catch\n        try {\n            int result = 10 / 0;  // This will throw ArithmeticException\n        } catch (ArithmeticException e) {\n            System.out.println("Cannot divide by zero!"); // Output: Cannot divide by zero!\n        } finally {\n            System.out.println("This block always executes.");\n        }\n    }\n}</code></pre>'),
(169, 4, 35, 'Simple Java Project Ideas', 'Here are some beginner-friendly Java project ideas to help you practice object-oriented programming, file handling, and GUI concepts:'),
(170, 4, 35, '1. Library Management System', 'A command-line-based project where users can add, delete, lend, and return books. You can use classes for Book, User, and Library. Include file I/O for persistent storage.'),
(171, 4, 35, '2. Student Grade Calculator', 'Create a program that allows input of student marks and calculates their average, grade, and performance. This reinforces conditionals, loops, and encapsulation.'),
(172, 4, 35, '3. Quiz Application', 'Develop a simple multiple-choice quiz app using Java. You can use arrays or ArrayLists to store questions and answers. Use file I/O to load questions from a file.'),
(173, 4, 35, '4. To-Do List Application', 'Build a console-based to-do list app where users can add, view, mark as complete, and delete tasks. Optionally, store tasks in a file or use serialization.'),
(174, 4, 35, '5. Banking System', 'Simulate a basic banking system where users can create accounts, deposit money, withdraw funds, and check balance. Focus on using classes and exception handling.'),
(175, 4, 35, '6. Digital Clock', 'Use Java Swing to create a GUI digital clock that displays the current system time. This introduces GUI components and timers.'),
(176, 4, 35, '7. Password Generator', 'Create a program that generates random passwords based on length and complexity selected by the user. Practice string manipulation and Java''s Random class.'),
(177, 4, 35, '8. Number Guessing Game', 'Write a game where the program generates a random number and the user has to guess it in as few tries as possible. Use loops and conditionals to provide feedback.'),
(178, 5, 36, 'Introduction to jQuery and Its Applications', 'jQuery is a fast, small, and feature-rich JavaScript library. It simplifies tasks like HTML document traversal and manipulation, event handling, and animation using a consistent, easy-to-use API.'),
(179, 5, 36, '1. What is jQuery?', 'jQuery is designed to simplify JavaScript code and execution across browsers. It allows developers to perform complex tasks with less code, including DOM manipulation, event handling, and animations.'),
(180, 5, 36, '2. Why Use jQuery?', 'Key reasons to use jQuery:\n- Simplifies JavaScript syntax\n- Handles cross-browser issues\n- Makes DOM manipulation easier\n- Supports animations and effects\n- Simplifies AJAX requests'),
(181, 5, 36, '3. jQuery Syntax', 'Basic syntax: $(selector).action();\n\nExample:\n$(document).ready(function() {\n    $("p").css("color", "blue");\n});\n\nThis changes all <p> elements to blue when the document is ready.'),
(182, 5, 36, '4. jQuery Applications', 'jQuery is used in many areas of web development, including DOM manipulation, event handling, animations, and AJAX.'),
(183, 5, 36, '4.1. DOM Manipulation', 'jQuery makes it easy to manipulate HTML content and style:\n\nExample:\n$(document).ready(function() {\n    $("#changeText").text("New Text Content");\n    $("div").css("background-color", "yellow");\n});'),
(184, 5, 36, '4.2. Event Handling', 'Attach events like click, hover, or keypress easily with jQuery:\n\nExample:\n$("#myButton").click(function() {\n    alert("Button clicked!");\n});'),
(185, 5, 36, '4.3. Animations and Effects', 'Use built-in methods like fadeIn and fadeOut:\n\nExample:\n$("#myDiv").fadeIn(1000);\n$("#myDiv").fadeOut(1000);'),
(186, 5, 36, '4.4. AJAX Support', 'jQuery simplifies asynchronous requests:\n\nExample:\n$.ajax({\n    url: "data.json",\n    method: "GET",\n    success: function(response) {\n        console.log(response);\n    }\n});'),
(187, 5, 36, '5. Conclusion', 'jQuery makes web development easier by simplifying JavaScript tasks like DOM manipulation, event handling, animations, and AJAX, and ensures better cross-browser compatibility.'),
(188, 5, 36, 'What is jQuery?', 'jQuery is a fast, small, and feature-rich JavaScript library. It makes things like HTML document traversal and manipulation, event handling, and animation much simpler with an easy-to-use API that works across a multitude of browsers.\n\nIt is designed to change the way that JavaScript is written and executed in web browsers, allowing developers to accomplish complex tasks with minimal code.'),
(189, 5, 37, 'Why Use jQuery?', '<ul>\r\n<li><strong>Simplifies JavaScript:</strong> jQuery offers a simple, concise syntax for writing code, which simplifies and reduces the amount of JavaScript needed.</li>\r\n<li><strong>Cross-browser compatibility:</strong> jQuery handles many browser inconsistencies, making it easier to write code that works across different browsers.</li>\r\n<li><strong>DOM manipulation:</strong> jQuery makes it easy to select and manipulate HTML elements and their properties, attributes, and content.</li>\r\n<li><strong>Animation support:</strong> It includes methods for creating animations and effects like fading and sliding.</li>\r\n<li><strong>AJAX support:</strong> jQuery simplifies working with AJAX requests for dynamic content loading and interaction.</li>\r\n</ul>'),
(190, 5, 38, 'jQuery Syntax', 'The basic syntax of jQuery is: <code>$(selector).action();</code>\n\nWhere <code>selector</code> is used to select an HTML element, and <code>action</code> is the jQuery method that performs some action on the selected element.\n\n<pre>$(document).ready(function() {\r\n    // jQuery code here\r\n    $("p").css("color", "blue");\r\n});</pre>\n\nThis code will change the color of all <code>p</code> elements to blue once the page is fully loaded.'),
(191, 5, 39, 'jQuery Applications', 'jQuery can be applied in several areas of web development. Below are some key applications:'),
(192, 5, 40, 'DOM Manipulation', 'jQuery allows you to easily select HTML elements and manipulate them, such as changing text, modifying HTML attributes, or adjusting the style.\n\n<pre>$(document).ready(function() {\r\n    $("#changeText").text("New Text Content");\r\n    $("div").css("background-color", "yellow");\r\n});</pre>'),
(193, 5, 41, 'Event Handling', 'jQuery simplifies event handling. You can easily attach events such as clicks, mouse movements, keypresses, etc., to elements.\n\n<pre>$("#myButton").click(function() {\r\n    alert("Button clicked!");\r\n});</pre>'),
(194, 5, 42, 'Animations and Effects', 'jQuery provides built-in methods to create animations, such as fading in and out, sliding up and down, and custom animations.\n\n<pre>$("#myDiv").fadeIn(1000);  // Fades in the element over 1 second\r\n$("#myDiv").fadeOut(1000);  // Fades out the element over 1 second</pre>'),
(195, 5, 43, 'AJAX Support', 'jQuery simplifies the process of making asynchronous requests (AJAX). It allows you to send and retrieve data without reloading the page.\n\n<pre>$.ajax({\r\n    url: "data.json",\r\n    method: "GET",\r\n    success: function(response) {\r\n        console.log(response);\r\n    }\r\n});</pre>\n\nThis AJAX code makes a GET request to fetch data from a "data.json" file and logs the response.'),
(196, 5, 44, 'Conclusion', 'jQuery is a powerful and easy-to-use JavaScript library that enhances the way developers write JavaScript code. It provides a simple syntax for DOM manipulation, event handling, animations, and AJAX requests, making web development more efficient and cross-browser compatible.'),
(197, 5, 37, 'Basic jQuery Syntax', 'The basic syntax of jQuery consists of the jQuery function <code>$(selector).action();</code>. The <code>selector</code> identifies the elements you want to work with, and the <code>action</code> represents the action or method you want to perform on them.\n\n<pre>$(document).ready(function() {\r\n    // Your jQuery code here\r\n    $("p").css("color", "blue");\r\n});</pre>\n\nIn the above example, we are selecting all <code>p</code> elements and changing their text color to blue.'),
(198, 5, 37, 'jQuery Selectors', 'Selectors are used to select HTML elements. jQuery uses CSS-style selectors to identify elements.'),
(199, 5, 37, 'ID Selector', 'The ID selector is used to select an element with a specific ID.\n\n<pre>$("#myElement").css("color", "green");</pre>'),
(200, 5, 37, 'Class Selector', 'The class selector selects all elements with a specific class.\n\n<pre>$(".myClass").css("color", "red");</pre>'),
(201, 5, 37, 'Element Selector', 'The element selector targets HTML elements based on their tag name.\n\n<pre>$("p").css("color", "blue");</pre>'),
(202, 5, 37, 'Universal Selector', 'The universal selector (<code>*</code>) selects all elements on the page.\n\n<pre>$("*").css("font-size", "18px");</pre>'),
(203, 5, 37, 'Filter and Traverse', 'jQuery provides several methods to filter and traverse elements within the DOM.'),
(204, 5, 37, 'Filter by Index', 'The <code>:eq()</code> selector allows you to filter elements by their index in the set.\n\n<pre>$("p:eq(1)").css("color", "orange");  // Selects the second paragraph</pre>'),
(205, 5, 37, 'Filter by Even and Odd', 'The <code>:even</code> and <code>:odd</code> selectors allow you to select elements based on their index being even or odd.\n\n<pre>$("p:even").css("color", "purple");  // Selects all even-indexed paragraphs\r\n$("p:odd").css("color", "pink");    // Selects all odd-indexed paragraphs</pre>'),
(206, 5, 37, 'Multiple Selectors', 'You can select multiple elements at once using a comma-separated list of selectors.\n\n<pre>$("p, .myClass").css("color", "brown");  // Selects all paragraphs and elements with the class ''myClass''</pre>'),
(207, 5, 38, '.click() - Click Event', 'Triggers an action when the element is clicked.\n\n<pre>$("#myButton").click(function() {\n    alert("Button was clicked!");\n});</pre>'),
(208, 5, 38, '.hover() - Hover Event', 'Triggers an action when the mouse enters or leaves the element.\n\n<pre>$("#myDiv").hover(\n    function() { \n        $(this).css("background-color", "yellow"); \n    },\n    function() { \n        $(this).css("background-color", "lightblue"); \n    }\n);</pre>'),
(209, 5, 38, '.focus() and .blur() - Focus & Blur Events', 'Triggers when the input field gains or loses focus.\n\n<pre>$("#myInput").focus(function() {\n    $(this).css("border", "2px solid blue");\n});\n$("#myInput").blur(function() {\n    $(this).css("border", "");\n});</pre>'),
(210, 5, 38, '.submit() - Submit Event', 'Triggered when a form is submitted. Can be used to prevent the default submission.\n\n<pre>$("#myForm").submit(function(event) {\n    event.preventDefault(); // Prevents the form from submitting the default way\n    alert("Form submitted!");\n});</pre>'),
(211, 5, 38, '.change() - Change Event', 'Triggered when the value of an input element (like a <code>&lt;select&gt;</code>, <code>&lt;input&gt;</code>, or <code>&lt;textarea&gt;</code>) changes.\n\n<pre>$("#mySelect").change(function() {\n    alert("Selection changed to: " + $(this).val());\n});</pre>'),
(212, 5, 38, '.keydown() - Keydown Event', 'Triggered when a key is pressed down on an element (e.g., an input field).\n\n<pre>$("#myInput").keydown(function(event) {\n    console.log("Key pressed: " + event.key);\n});</pre>'),
(213, 5, 38, 'Event Delegation with .on()', 'Allows you to attach event handlers to dynamically added elements.\n\n<pre>$(document).on("click", ".dynamicButton", function() {\n    alert("Dynamically added button clicked!");\n});</pre>'),
(214, 5, 39, '.hide() and .show() - Hide and Show Effects', 'Used to hide or show elements with a smooth transition.\n\n<pre>$("#effectBox").hide();  // Hides the element\n$("#effectBox").show();  // Shows the element</pre>'),
(215, 5, 39, '.fadeIn() and .fadeOut() - Fade Effects', 'Fade an element in or out with a smooth transition.\n\n<pre>$("#effectBox").fadeIn(1000);  // Fades the element in\n$("#effectBox").fadeOut(1000);  // Fades the element out</pre>'),
(216, 5, 39, '.slideUp() and .slideDown() - Slide Effects', 'Slides an element up or down, hiding or showing it with a smooth transition.\n\n<pre>$("#effectBox").slideUp();  // Slides the element up (hide)\n$("#effectBox").slideDown();  // Slides the element down (show)</pre>'),
(217, 5, 39, '.slideToggle() - Slide Toggle Effect', 'Toggles between sliding up and sliding down an element.\n\n<pre>$("#effectBox").slideToggle();  // Toggles between sliding up/down</pre>'),
(218, 5, 39, '.animate() - Custom Animation', 'Used to create custom animations with specific properties like width, height, etc.\n\n<pre>$("#effectBox").animate({\n    width: "300px",  // Increase the width\n    height: "300px"  // Increase the height\n}, 1000);  // Duration in milliseconds</pre>'),
(219, 5, 40, '.append() and .prepend() - Add Content', 'Used to add new content inside an element at the end or at the beginning.\n\n<pre>$("#parentDiv").append("<p>Appended paragraph</p>");  // Adds content to the end\n$("#parentDiv").prepend("<p>Prepended paragraph</p>");  // Adds content to the beginning</pre>'),
(220, 5, 40, '.remove() - Remove Content', 'Used to remove elements from the DOM.\n\n<pre>$("#myDiv").remove();  // Removes the element from the DOM</pre>'),
(221, 5, 40, '.text() and .html() - Modify Text and HTML', 'Used to get or set the text content or HTML content of an element.\n\n<pre>$("#myDiv").text("New text content!");  // Sets the text content\n$("#myDiv").html("<strong>Bold HTML content</strong>");  // Sets HTML content</pre>'),
(222, 5, 40, '.attr() - Modify Attributes', 'Used to get or set attributes like <code>src</code>, <code>href</code>, etc.\n\n<pre>$("#myImage").attr("src", "https://via.placeholder.com/150");  // Change the src attribute of an image\n$("#myLink").attr("href", "https://www.example.com");  // Change the href attribute of a link</pre>'),
(223, 5, 40, '.addClass(), .removeClass(), and .toggleClass() - Class Manipulation', 'Used to add, remove, or toggle classes for styling purposes.\n\n<pre>$("#myDiv").addClass("bg-primary");  // Adds a class\n$("#myDiv").removeClass("bg-primary");  // Removes a class\n$("#myDiv").toggleClass("bg-success");  // Toggles a class</pre>'),
(224, 5, 40, '.replaceWith() - Replace Content', 'Used to replace an element with new content.\n\n<pre>$("#oldElement").replaceWith("<div id=''newElement''>New Content</div>");</pre>'),
(225, 5, 40, '.clone() - Clone Elements', 'Used to create a copy of an element and optionally include its data and events.\n\n<pre>var cloned = $("#myDiv").clone();  // Clones the element\ncloned.appendTo("body");  // Adds the cloned element to the body</pre>'),
(226, 5, 41, '.css() - Change CSS Properties', 'Used to get or set CSS properties of an element. You can change styles such as color, font size, margin, etc.\n\n<pre>$("#myBox").css("background-color", "lightblue");  // Change the background color\n$("#myBox").css("width", "300px");  // Change the width</pre>'),
(227, 5, 41, '.css() - Set Multiple CSS Properties', 'You can change multiple CSS properties at once by passing an object with property-value pairs.\n\n<pre>$("#myBox").css({\n    "background-color": "lightgreen",  // Set background color\n    "width": "350px",  // Set width\n    "height": "350px",  // Set height\n    "border-radius": "15px"  // Set border radius\n});</pre>'),
(228, 5, 41, '.css() - Get CSS Properties', 'You can use <code>.css()</code> to get the value of a CSS property.\n\n<pre>var bgColor = $("#myBox").css("background-color");  // Get the background color</pre>'),
(229, 5, 41, '.show() and .hide() - Show and Hide Elements', 'Use these methods to show or hide an element using the <code>display</code> CSS property.\n\n<pre>$("#myBox").hide();  // Hide the element\n$("#myBox").show();  // Show the element</pre>'),
(230, 5, 41, '.fadeIn() and .fadeOut() - Fade Effects', 'These methods gradually change the opacity of an element to create a fade-in or fade-out effect.\n\n<pre>$("#myBox").fadeIn(1000);  // Fade in the element\n$("#myBox").fadeOut(1000);  // Fade out the element</pre>'),
(231, 5, 41, '.slideUp() and .slideDown() - Slide Effects', 'These methods slide an element up or down, hiding or showing it smoothly.\n\n<pre>$("#myBox").slideUp();  // Slide up (hide) the element\n$("#myBox").slideDown();  // Slide down (show) the element</pre>'),
(232, 5, 41, '.toggleClass() - Toggle CSS Classes', 'Toggle classes to add or remove styles dynamically.\n\n<pre>$("#myBox").toggleClass("bg-primary");  // Toggle background color</pre>'),
(233, 8, 42, 'What is SQL?', '<div class="content">\r\n        <h2>What is SQL?</h2>\r\n        <p>SQL, or Structured Query Language, is a standard programming language used to manage and manipulate relational databases. It provides a way to interact with data stored in a relational database management system (RDBMS), making it essential for querying, inserting, updating, and deleting data.</p>\r\n        <p>SQL allows users to manage structured data and perform operations like sorting, filtering, and aggregating information. It is an essential tool for developers, analysts, and anyone working with databases.</p>\r\n    </div>'),
(234, 8, 42, 'DQL (Data Query Language)', '<div class="category">\r\n        <h3>DQL (Data Query Language)</h3>\r\n        <p>DQL is used for querying and retrieving data from the database.</p>\r\n        <p><strong>Primary Command:</strong> <code>SELECT</code></p>\r\n        <p class="code">Example:</p>\r\n        <pre class="code-block">SELECT * FROM employees WHERE department = ''HR'';</pre>\r\n    </div>'),
(235, 8, 42, 'DML (Data Manipulation Language)', '<div class="category">\r\n        <h3>DML (Data Manipulation Language)</h3>\r\n        <p>DML allows you to insert, update, and delete data within database tables.</p>\r\n        <p><strong>Primary Commands:</strong></p>\r\n        <ul>\r\n            <li><code>INSERT INTO</code>: Adds new data.</li>\r\n            <li><code>UPDATE</code>: Modifies existing data.</li>\r\n            <li><code>DELETE</code>: Removes data.</li>\r\n        </ul>\r\n        <p class="code">Example:</p>\r\n        <pre class="code-block">\r\nINSERT INTO employees (name, age, department) \r\nVALUES (''John Doe'', 30, ''HR'');\r\n\r\nUPDATE employees SET age = 31 WHERE name = ''John Doe'';\r\n\r\nDELETE FROM employees WHERE name = ''John Doe'';\r\n        </pre>\r\n    </div>'),
(236, 8, 42, 'DDL (Data Definition Language)', '<div class="category">\r\n        <h3>DDL (Data Definition Language)</h3>\r\n        <p>DDL is used for defining and modifying database structures, such as tables, schemas, and indexes.</p>\r\n        <p><strong>Primary Commands:</strong></p>\r\n        <ul>\r\n            <li><code>CREATE</code>: Defines new database objects (e.g., tables).</li>\r\n            <li><code>ALTER</code>: Modifies existing objects.</li>\r\n            <li><code>DROP</code>: Deletes objects.</li>\r\n        </ul>\r\n        <p class="code">Example:</p>\r\n        <pre class="code-block">\r\nCREATE TABLE employees (id INT, name VARCHAR(100), age INT);\r\n\r\nALTER TABLE employees ADD COLUMN salary DECIMAL(10, 2);\r\n\r\nDROP TABLE employees;\r\n        </pre>\r\n    </div>'),
(237, 8, 42, 'DCL (Data Control Language)', '<div class="category">\r\n        <h3>DCL (Data Control Language)</h3>\r\n        <p>DCL manages access permissions for users in the database.</p>\r\n        <p><strong>Primary Commands:</strong></p>\r\n        <ul>\r\n            <li><code>GRANT</code>: Gives specific privileges to a user.</li>\r\n            <li><code>REVOKE</code>: Removes privileges from a user.</li>\r\n        </ul>\r\n        <p class="code">Example:</p>\r\n        <pre class="code-block">\r\nGRANT SELECT ON employees TO user1;\r\n\r\nREVOKE DELETE ON employees FROM user1;\r\n        </pre>\r\n    </div>'),
(238, 8, 42, 'TCL (Transaction Control Language)', '<div class="category">\r\n        <h3>TCL (Transaction Control Language)</h3>\r\n        <p>TCL is used to manage transactions, ensuring that database operations are processed safely.</p>\r\n        <p><strong>Primary Commands:</strong></p>\r\n        <ul>\r\n            <li><code>COMMIT</code>: Saves changes made during a transaction.</li>\r\n            <li><code>ROLLBACK</code>: Reverts changes if something goes wrong.</li>\r\n            <li><code>SAVEPOINT</code>: Sets a point to which you can later roll back.</li>\r\n        </ul>\r\n        <p class="code">Example:</p>\r\n        <pre class="code-block">\r\nCOMMIT;\r\n\r\nROLLBACK;\r\n        </pre>\r\n    </div>'),
(239, 8, 43, 'SQL*Plus SELECT Statement Example', '<h1>SQL*Plus SELECT Statement Example</h1>'),
(240, 8, 43, '1. Basic SELECT Statement', '<div class="section">\r\n        <h2>1. Basic SELECT Statement</h2>\r\n        <p class="description">\r\n            The <code>SELECT</code> statement is used to retrieve data from a database. \r\n            Below is an example of selecting specific columns from a table:\r\n        </p>\r\n        <pre>\r\nSELECT employee_id, first_name, last_name FROM employees;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nemployee_id | first_name | last_name\r\n-----------------------------------\r\n1001        | John       | Doe\r\n1002        | Jane       | Smith\r\n            </pre>\r\n        </div>\r\n    </div>'),
(241, 8, 43, '2. Selecting All Columns', '<div class="section">\r\n        <h2>2. Selecting All Columns</h2>\r\n        <p class="description">\r\n            You can select all columns from a table using <code>*</code>:\r\n        </p>\r\n        <pre>\r\nSELECT * FROM employees;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nemployee_id | first_name | last_name | department_id | salary\r\n-----------------------------------------------------------\r\n1001        | John       | Doe       | 10            | 5000\r\n1002        | Jane       | Smith     | 20            | 6000\r\n            </pre>\r\n        </div>\r\n    </div>'),
(242, 8, 43, '3. Filtering Results Using WHERE', '<div class="section">\r\n        <h2>3. Filtering Results Using WHERE</h2>\r\n        <p class="description">\r\n            You can filter the results with the <code>WHERE</code> clause. For example, \r\n            selecting employees from a specific department:\r\n        </p>\r\n        <pre>\r\nSELECT employee_id, first_name, last_name\r\nFROM employees\r\nWHERE department_id = 10;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nemployee_id | first_name | last_name\r\n-----------------------------------\r\n1001        | John       | Doe\r\n            </pre>\r\n        </div>\r\n    </div>'),
(243, 8, 43, '4. Sorting Results Using ORDER BY', '<div class="section">\r\n        <h2>4. Sorting Results Using ORDER BY</h2>\r\n        <p class="description">\r\n            To sort the results, you can use the <code>ORDER BY</code> clause:\r\n        </p>\r\n        <pre>\r\nSELECT employee_id, first_name, last_name\r\nFROM employees\r\nORDER BY last_name ASC;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nemployee_id | first_name | last_name\r\n-----------------------------------\r\n1002        | Jane       | Smith\r\n1001        | John       | Doe\r\n            </pre>\r\n        </div>\r\n    </div>'),
(244, 8, 43, '5. Limiting Results Using ROWNUM', '<div class="section">\r\n        <h2>5. Limiting Results Using ROWNUM</h2>\r\n        <p class="description">\r\n            You can limit the number of rows returned using the <code>ROWNUM</code> clause:\r\n        </p>\r\n        <pre>\r\nSELECT employee_id, first_name, last_name\r\nFROM employees\r\nWHERE ROWNUM <= 5;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nemployee_id | first_name | last_name\r\n-----------------------------------\r\n1001        | John       | Doe\r\n1002        | Jane       | Smith\r\n            </pre>\r\n        </div>\r\n    </div>'),
(245, 8, 43, '6. Using Aliases for Columns', '<div class="section">\r\n        <h2>6. Using Aliases for Columns</h2>\r\n        <p class="description">\r\n            You can use aliases for columns using the <code>AS</code> keyword to make the output more readable:\r\n        </p>\r\n        <pre>\r\nSELECT first_name AS "First Name", last_name AS "Last Name"\r\nFROM employees;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nFirst Name | Last Name\r\n-----------------------\r\nJohn       | Doe\r\nJane       | Smith\r\n            </pre>\r\n        </div>\r\n    </div>'),
(246, 8, 43, '7. Aggregation with COUNT', '<div class="section">\r\n        <h2>7. Aggregation with COUNT</h2>\r\n        <p class="description">\r\n            You can use aggregation functions like <code>COUNT()</code> to perform calculations on the data:\r\n        </p>\r\n        <pre>\r\nSELECT COUNT(*) FROM employees;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\nCOUNT(*)\r\n--------\r\n2\r\n            </pre>\r\n        </div>\r\n    </div>'),
(247, 8, 43, '8. Grouping Data with GROUP BY', '<div class="section">\r\n        <h2>8. Grouping Data with GROUP BY</h2>\r\n        <p class="description">\r\n            To group the data and calculate aggregates by category, you can use the <code>GROUP BY</code> clause:\r\n        </p>\r\n        <pre>\r\nSELECT department_id, COUNT(*) AS num_employees\r\nFROM employees\r\nGROUP BY department_id;\r\n        </pre>\r\n        <div class="example-output">\r\n            <p>Example Output:</p>\r\n            <pre>\r\ndepartment_id | num_employees\r\n-----------------------------\r\n10            | 1\r\n20            | 1\r\n            </pre>\r\n        </div>\r\n    </div>'),
(248, 8, 44, 'SQL Query Results', '<h1>SQL Query Results</h1>'),
(249, 8, 44, 'Querying All Columns (SELECT *)', '<h2>Querying All Columns (SELECT *)</h2>\r\n    <table>\r\n        <thead>\r\n            <tr>\r\n                <th>Employee ID</th>\r\n                <th>First Name</th>\r\n                <th>Last Name</th>\r\n                <th>Salary</th>\r\n                <th>Department</th>\r\n            </tr>\r\n        </thead>\r\n        <tbody>\r\n            <tr>\r\n                <td>1</td>\r\n                <td>John</td>\r\n                <td>Doe</td>\r\n                <td>$60,000</td>\r\n                <td>Engineering</td>\r\n            </tr>\r\n            <tr>\r\n                <td>2</td>\r\n                <td>Jane</td>\r\n                <td>Smith</td>\r\n                <td>$55,000</td>\r\n                <td>Marketing</td>\r\n            </tr>\r\n            <tr>\r\n                <td>3</td>\r\n                <td>Jim</td>\r\n                <td>Beam</td>\r\n                <td>$70,000</td>\r\n                <td>HR</td>\r\n            </tr>\r\n        </tbody>\r\n    </table>'),
(250, 8, 44, 'Querying Multiple Columns (SELECT first_name, last_name, salary)', '<h2>Querying Multiple Columns (SELECT first_name, last_name, salary)</h2>\r\n    <table>\r\n        <thead>\r\n            <tr>\r\n                <th>First Name</th>\r\n                <th>Last Name</th>\r\n                <th>Salary</th>\r\n            </tr>\r\n        </thead>\r\n        <tbody>\r\n            <tr>\r\n                <td>John</td>\r\n                <td>Doe</td>\r\n                <td>$60,000</td>\r\n            </tr>\r\n            <tr>\r\n                <td>Jane</td>\r\n                <td>Smith</td>\r\n                <td>$55,000</td>\r\n            </tr>\r\n            <tr>\r\n                <td>Jim</td>\r\n                <td>Beam</td>\r\n                <td>$70,000</td>\r\n            </tr>\r\n        </tbody>\r\n    </table>'),
(251, 8, 45, 'SQL Commands and Concepts', '<h1>SQL Commands and Concepts</h1>'),
(252, 8, 45, '1. DESCRIBE Command in SQL', '<div class="section">\r\n        <h2>1. DESCRIBE Command in SQL</h2>\r\n        <p>The <strong>DESCRIBE</strong> command (or <strong>DESC</strong>) is used to view the structure of a table in SQL. It provides details about the columns in the table, such as their names, data types, and constraints.</p>\r\n        \r\n        <h3>Syntax:</h3>\r\n        <pre>DESCRIBE table_name;</pre>\r\n        <p>Or</p>\r\n        <pre>DESC table_name;</pre>\r\n\r\n        <h3>Example:</h3>\r\n        <pre>DESCRIBE employees;</pre>\r\n        <p class="example">This query will return a list of columns in the "employees" table, including their data types and constraints.</p>\r\n    </div>'),
(253, 8, 45, '2. Column Alias in SQL', '<div class="section">\r\n        <h2>2. Column Alias in SQL</h2>\r\n        <p>A <strong>column alias</strong> is a temporary name given to a column or expression in a SQL query. This is often used to improve the readability of the output or to rename a column in the result set.</p>\r\n        \r\n        <h3>Syntax:</h3>\r\n        <pre>SELECT column_name AS alias_name FROM table_name;</pre>\r\n        <p>Or</p>\r\n        <pre>SELECT column_name alias_name FROM table_name;</pre>\r\n\r\n        <h3>Example:</h3>\r\n        <pre>SELECT first_name AS "First Name", last_name AS "Last Name", salary * 12 AS "Annual Salary"\r\nFROM employees;</pre>\r\n        <p class="example">This query will display the "First Name", "Last Name", and "Annual Salary" columns in the output, instead of the default column names or expressions.</p>\r\n\r\n        <h3>Using Aliases with Aggregate Functions:</h3>\r\n        <pre>SELECT department, SUM(salary) AS "Total Salary"\r\nFROM employees\r\nGROUP BY department;</pre>\r\n        <p class="example">In this query, the "SUM(salary)" is given the alias "Total Salary" to clarify the meaning of the result in the output.</p>\r\n    </div>');
...
(3, 'Kyomu', 'kyomu@gmail.com', 'Admin', '123', '2025-04-19 19:28:22'),
(4, 'vicky', 'vicky@gmail.com', 'User', '123', '2025-04-19 19:29:12'),
(5, 'ceaser', 'ceaser@gmail.com', 'Admin', '123', '2025-04-19 19:40:15'),
(6, 'Sam', 'sam@gmail.com', 'User', '123', '2025-04-19 19:45:40'),
(1, 'Julius', 'mukubyajulius@gmail.com', 'Admin', '123', '2025-04-20 18:51:28'),
(11, 'Cisco', 'cisco@gmail.com', 'User', '123', '2025-04-22 17:05:57');
--
-- Database: `skyline`
--
CREATE DATABASE `skyline` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `skyline`;
...
(25, 'ABC Customer', '070100100', 'Nakawa');
...
INSERT INTO `employee` (`employee_ID`, `project_ID`, `employee_name`, `phone`, `address`) VALUES
(1, 14, 'John', 'Ntinda', '0705674551');
...
INSERT INTO `inventory` (`inventory_ID`, `item_name`, `quantity`) VALUES
(17, 'cement bags', 0),
(18, 'cement', 0);
...
CREATE TABLE IF NOT EXISTS `inventory_orders` (
  ...
  KEY `FK_inventory_orders_1` (`inventory_ID`)
...
INSERT INTO `inventory_orders` (`order_ID`, `inventory_ID`, `quantity`, `cost`, `total`) VALUES
(97, 17, 5, 30000, 300000),
(98, 18, 10, 35000, 350000),
(100, 18, 10, 30000, 300000);
...
CREATE TABLE IF NOT EXISTS `inventory_supplier` (
  ...
  `unit_cost` varchar(45) NOT NULL DEFAULT '',
...
INSERT INTO `inventory_supplier` (`inventory_ID`, `supplier_ID`, `unit_cost`) VALUES
(17, 93, '30000'),
(18, 94, '35000');
...
INSERT INTO `orders` (`order_ID`, `supplier_ID`, `order_date`, `order_status`) VALUES
(97, 93, '2025-04-16', ''),
(98, 94, '2025-04-14', ''),
(99, 95, '2025-04-17', ''),
(100, 96, '2025-04-17', '');
...
INSERT INTO `project` (`project_ID`, `customer_ID`, `project_name`, `start_date`, `end_date`, `budget`, `status`) VALUES
(14, 25, 'ABC', '2025-04-15', '2025-04-18', 1000000, 'Delayed');
...
CREATE TABLE IF NOT EXISTS `project_inventory` (
  ...
  KEY `fk_project_ID_1` (`project_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `project_inventory` (`inventory_ID`, `project_ID`, `quantity`, `cost`) VALUES
(18, 14, '1', NULL);
...
INSERT INTO `supplier` (`supplier_ID`, `supplier_name`, `email`, `address`) VALUES
(93, 'Julius', 'abc@gmail.com', 'abc'),
(94, 'Hima', 'hima@gmail.com', 'Tororo'),
(95, 'ABC Limited', 'abc@gmail.com', 'Ntinda'),
(96, 'ABC', 'abc@gmail.com', 'abc');
...
(1, 'ceaser', '12300', 'Procurement Manager'),
(2, 'Julius', '123', 'Admin'),
(3, 'Vicky', '345', 'Project Manager'),
(4, 'Betty', '2003', 'Supplier Manager'),
(5, 'Matthew', '567', 'Inventory manager'),
(6, 'Sylvia', '345', 'Human Resource Manager'),
(7, 'Samuel', '900', 'Customer Manager');
...
ALTER TABLE `inventory_orders`
  ADD CONSTRAINT `FK_inventory_orders_1` FOREIGN KEY (`inventory_ID`) REFERENCES `inventory` (`inventory_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_inventory_orders_2` FOREIGN KEY (`order_ID`) REFERENCES `orders` (`order_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_orders` FOREIGN KEY (`supplier_ID`) REFERENCES `supplier` (`supplier_ID`) ON DELETE CASCADE;
...
--
-- Constraints for table `project_inventory`
--
ALTER TABLE `project_inventory`
  ADD CONSTRAINT `fk_inventory_ID_1` FOREIGN KEY (`inventory_ID`) REFERENCES `inventory` (`inventory_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_project_ID_1` FOREIGN KEY (`project_ID`) REFERENCES `project` (`project_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `studentdatabase`
--
CREATE DATABASE `studentdatabase` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `studentdatabase`;
...
--
CREATE DATABASE `userdatabase` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `userdatabase`;
